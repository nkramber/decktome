...
74 probe conversations ran beside the gate. They asked 296 questions, and the model offered 15 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
| Conversations | 30 |
| Questions asked | 139 |
| From the catalog | 137 |
| Invented by the model | 2 |
| Replacements refused as rewords | 2 |
| Catalog questions that closed a slot | 104 |
...
- Calls: 737. Time: 1175.0 seconds.
- Tokens: 713305 input (297560 cached), 63774 output.
- Cost: $0.1656.
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for your blink deck?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Would you like Grist, the Hunger Tide as your commander, or as one card in the 99?
...
- [catalog slot=pool_rule row=pool fit=0.20 filled=true] Should I use your library first, restrict the deck to cards from your library, or ignore your library for a fully optimized deck?
...
- [catalog slot=power row=power_sixty_confirm fit=0.50 filled=true] Should I build for tournament-level competition, FNM-level competition, or casual play?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format is FNM running: Standard, Modern, or Commander?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like for the mill deck?
  - Options: Commander / Standard / Modern
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget_scope fit=0.90 filled=true] Is the $100 limit for the cards you buy or for the deck's total value?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for your white-black Commander deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.20 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
  - Refused as a reword (D-88): What level of power should the deck target: low power, precon level (2), upgraded (3), or high power (4)?
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] You have four Dinosaur cards, while the target is at least 30. Should I prioritize cards you own and add a buy list, or use the entire pool?
  - Options: Owned cards first, then a buy list / Use the entire pool
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Your library is thin for this extra-turns theme. Should I build owned-first with a buy list, or use the whole pool?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with cards from your library, use only cards from it, or ignore it for a fully optimized deck?
  - Options: Start with cards from my library / Use only cards from my library / Ignore my library
...
- [catalog slot=format row=format_unsupported_open fit=0.05 filled=false] I do not build Legacy. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): I do not build Legacy. Which format should I build instead: Commander, Standard, or Modern?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only cards from it, or ignore it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
- [INVENTED slot=locked row=locked fit=0.20 filled=true] Should Grist, the Hunger Tide stay in the deck even though it will not be the commander?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a blue-red commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=budget row=budget_scope fit=0.50 filled=true] Is your budget a cap on the cards you buy, or on the whole deck's value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format is your FNM running: Standard, Modern, or Commander?
  - Options: Standard / Modern / Commander
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=theme row=theme_competitive fit=0.90 filled=true] For the event, do you want a named top-tier deck or the best deck possible under your budget?
  - Options: A named deck / The best deck under budget
- [INVENTED slot=power row=power_sixty_confirm fit=0.20 filled=true] What power level should the deck target?
...
- [catalog slot=theme row=theme_competitive fit=0.05 filled=true] Would you like a specific established deck, or the best option within your $50 budget?
  - Options: A named deck / The best deck under budget
- [catalog slot=power row=power_sixty_confirm fit=0.05 filled=true] Should I build the deck at tournament level?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for?
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Since the card pool is thin for this theme, should I prioritize cards you own and provide a buy list, or use the whole pool?
  - Options: Owned-first with a buy list / Use the whole pool
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Would you like Karlov of the Ghost Council to lead the deck, or should it be included among the other cards?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with your card library, restrict the deck to it, or build without using it?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.05 filled=false] Should the deck keep every card you named, or may I cut cards that don’t fit the burn plan?
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build the deck at tournament level, FNM level, or casual power?
  - Options: Tournament level / FNM level / Casual
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck use cards from your library first, only cards from your library, or can I ignore your library for a fully optimized build?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with your library, use only cards from it, or build without restricting the card pool?
  - Options: Start with my library / Use only my library / Optimize without my library
- [INVENTED slot=locked row=locked fit=0.20 filled=false] Should the deck keep every card you named, or may I cut cards that do not fit?
...
- [catalog slot=format row=format_unsupported_open fit=0.20 filled=false] I do not build Vintage. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): I don't build Vintage. Which format should I build instead: Commander, Standard, or Modern?
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build the deck at tournament level, or would you prefer FNM or casual power?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=meta row=meta fit=0.90 filled=false] Which decks do you expect to face, or should I keep the sideboard general?
  - Options: I will name the decks / Keep the sideboard general
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build this at tournament level, or would you prefer FNM-level or casual power?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I prioritize cards from your library, restrict the deck to them, or build without using them for maximum optimization?
  - Options: Prioritize my library / Use only my library / Do not use my library
- [catalog slot=budget row=budget_scope fit=0.90 filled=true] Does your budget cap apply to the cards you buy or to the entire deck's value?
...
- [INVENTED slot=power row=power_sixty_confirm fit=0.20 filled=false] What power level should the deck target?
  - Options: Tournament-level / FNM-level / Casual
  - It replaced: You asked for a competitive deck, so I will build to tournament level. Is that right?
- [catalog slot=meta row=meta fit=0.90 filled=false] Which decks do you expect to face, or should I keep the sideboard general?
  - Options: I'll name the decks / Keep it general
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the colorless Commander deck target?
  - Options: 1 — exhibition / 2 — core / 3 — upgraded / 4 — optimized / 5 — cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=power row=power_commander fit=0.05 filled=false] Which power bracket should the deck target?
  - Options: Bracket 1 / Bracket 2 / Bracket 3 / Bracket 4 / Bracket 5
  - Refused as a reword (D-88): Which power bracket should the deck target: 2 (precon level), 3 (upgraded), or another bracket?
  - The guard compared against: Which power bracket should the deck target? 2 is precon level, 3 is upgraded, 4 is high power.
- [catalog slot=budget row=budget fit=0.90 filled=false] How much, if anything, would you like to spend on cards to buy?
...
- [catalog slot=power row=power_sixty_confirm fit=0.20 filled=false] Should I build the deck for tournament-level competition?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=meta row=meta fit=0.90 filled=false] Which decks do you expect to face, or should I keep the sideboard general?
  - Options: I’ll name the decks / Keep the sideboard general
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a black-green commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.20 filled=false] Should I build from your library first, use only cards from your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
  - Refused as a reword (D-88): Should I build from your library only, or ignore it for a fully optimized deck?
  - The guard compared against: Build from your library first, only your library, or ignore it for a fully optimized deck?
...
- [catalog slot=theme row=theme fit=0.90 filled=true] What would you like the deck to do: use a creature type, mechanic, or particular play style?
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target?
  - Options: 1 Exhibition / 2 Core / 3 Upgraded / 4 Optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=meta row=meta fit=0.90 filled=false] Which decks do you expect to face, or should I keep the sideboard general?
  - Options: Name the decks / Keep the sideboard general
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] For the artifacts and lifegain theme, which of the two common plans do you want?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or would you like me to suggest one for the deck?
  - Options: I have one in mind / Suggest one
