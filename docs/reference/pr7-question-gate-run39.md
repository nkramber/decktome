...
| Catalog questions that closed a slot | 231 |
...
- Suite `questions`, run `pr7-question-gate-run39`, on 2026-09-05, commit `4ee191c`.
...
- Calls: 672. Cost: $0.1915. Time: 1145 seconds.
- Cards: snapshot loaded, 2471 entries, 4316 cards, 1 rows unresolved.
- Tokens: 1057374 input (554112 cached), 66491 output.
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should I build the blink deck in: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Do you want Grist, the Hunger Tide leading the deck or included among the other cards?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format does FNM run: Standard, Modern, or Commander?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Do you want Brago leading the deck, or included among the other cards?
  - Options: As my commander / In the 99
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: 2 for a precon-like build, 3 for an upgraded build, 4 for a high-power build, or another level?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=commander row=commander fit=0.35 filled=true] Which commander do you want? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power bracket should the deck target: near a precon, upgraded, high power, or cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with cards from your library, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=format row=format_unsupported_open fit=0.35 filled=true] I do not build Pauper. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=budget row=budget fit=0.90 filled=true] What spending limit, if any, should I use for cards you do not own?
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Should I start with the cards you own and add a buy list, or use the entire pool?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.20 filled=true] Should I prioritize cards you already own and add a buy list, or use the whole pool?
  - Options: Owned-first with a buy list / Use the whole pool
  - Refused as a reword (D-88): Build owned-first with a buy list, or use the whole pool?
  - The guard compared against: Your library is thin for this theme. Build owned-first with a buy list, or use the whole pool?
- [catalog slot=commander row=commander fit=0.35 filled=true] Which commander do you want? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=pool_rule row=pool fit=0.05 filled=true] Should the deck use your existing library as a starting point, use only cards from it, or ignore it for a fully optimized build?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the reanimator deck target? Choose 1 for exhibition, 2 for core, 3 for upgraded, 4 for optimized, or 5 for cEDH.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=commander row=commander fit=0.35 filled=true] Which commander do you want? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=budget row=budget_scope fit=0.90 filled=true] Does your budget cover only the cards you buy, or the deck's total value?
  - Options: The cards I buy / The whole deck
- [catalog slot=commander row=commander fit=0.35 filled=true] Which commander do you want? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format are you building for: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=theme row=theme fit=0.90 filled=true] What should the deck focus on: a creature type, a mechanic, or a play style?
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target: 2 for a core build, 3 for an upgraded build, or 4 for a high-power build? You can also choose 1 or 5.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Should I prioritize the cards you already own and provide a buy list, or use the entire card pool?
  - Options: Owned-first with a buy list / Use the whole pool
- [catalog slot=commander row=commander_pick fit=0.35 filled=true] Which commander do you want: Syr Konrad, the Grim, Etali, Primal Storm, or Ragavan, Nimble Pilferer? Say "none" and I name three more.
  - Options: Syr Konrad, the Grim / Etali, Primal Storm / Ragavan, Nimble Pilferer / None, name three more
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.20 filled=true] Should I prioritize the cards you own and provide a buy list, or use the entire available pool?
  - Options: Owned-first with a buy list / Use the whole pool
  - Refused as a reword (D-88): Should I build owned-first with a buy list, or use the whole pool of dinosaur stompy cards?
  - The guard compared against: Your library holds 5 dinosaur stompy cards. I want 30 or more. Build owned-first with a buy list, or use the whole pool?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Do you want Karlov of the Ghost Council as the commander, or as one card in the 99?
  - Options: As my commander / In the 99
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] For this land-destruction deck, should I build around what you own and add a buy list, or use the full pool?
  - Options: Owned-first with a buy list / Use the whole pool
- [catalog slot=commander row=commander_pick fit=0.35 filled=true] Which commander do you want: Etali, Primal Conqueror // Etali, Primal Sickness, Omnath, Locus of Rage, or Xenagos, God of Revels? Say "none" and I name three more.
  - Options: Etali, Primal Conqueror // Etali, Primal Sickness / Omnath, Locus of Rage / Xenagos, God of Revels / None, name three more
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck use your library as a starting point, restrict itself to cards from your library, or be optimized without considering your library?
  - Options: Library first / Only my library / Ignore my library
- [catalog slot=commander row=commander fit=0.35 filled=true] Which commander do you want? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=format row=format_unsupported_open fit=0.35 filled=true] I do not build Vintage. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=house_rules row=house_format_limits fit=0.35 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  - Options: Yes, the normal limits / No, I will say the limits
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference for the deck?
...
- [catalog slot=pool_rule row=pool_precon fit=0.20 filled=true] Should I start with your precon, use only cards from it, or ignore it for a fully optimized deck?
...
Expected slots: 1 misses. colors: want none, got WUBRG.
...
- [catalog slot=power row=power_commander fit=0.05 filled=false] Which power bracket should the deck target? You mentioned 2 or 3; choose one, or name another.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: 2 for near a precon, 3 for upgraded, or 4 for high power?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] What spending limit, if any, should I use for cards you do not own?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the Voltron deck target? 2 is near a preconstructed deck, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] What spending limit, if any, should I use for cards you do not own?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck aim for? 2 is close to a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=budget row=budget fit=0.90 filled=false] What spending limit, if any, should I use for cards you do not own?
...
- [catalog slot=theme row=theme fit=0.90 filled=true] Should the deck center on a creature type, a mechanic, or a play style? You can also leave that open for a surprise.
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] What spending limit, if any, should I use for cards you do not own?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target? Choose from near-precon, upgraded, high-power, optimized, or cEDH.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=budget row=budget fit=0.90 filled=true] What spending limit, if any, should I use for cards you do not own?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Do you want Bruvac the Grandiloquent leading the deck, or included among the other cards?
  - Options: As my commander / In the 99
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use cards from your library first, only cards from your library, or build without using it?
  - Options: Library first / Only my library / Ignore my library
- [catalog slot=budget row=budget_scope fit=0.90 filled=false] Does your budget limit apply to the cards you buy or to the whole deck's value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power bracket should the deck target: exhibition, core, upgraded, optimized, or cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
