...
75 probe conversations ran beside the gate. They asked 302 questions, and the model offered 11 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
- Calls: 743. Time: 1342.8 seconds.
- Tokens: 720444 input (301762 cached), 63395 output.
- Cost: $0.1658.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the Commander deck target? Bracket 2 is precon level, 3 is upgraded, and 4 is high power.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the blink deck target?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Should Grist, the Hunger Tide be your commander or one card in the deck?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=power row=jank fit=0.90 filled=true] What kind of janky sounds fun to you: a low-power deck, an unexpected card, or a plan that almost never works?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=theme row=theme fit=0.90 filled=true] What would you like the deck to do—focus on a creature type, a mechanic, or a play style?
- [INVENTED slot=house_rules row=house_rules fit=0.20 filled=true] Should I follow a no-ban-list rule, or did you mean something else?
...
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] Which of the two common plans do you want for the deck?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the Karlov lifegain deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
...
- [catalog slot=pool_rule row=pool_precon fit=0.50 filled=true] Should I start with your Atraxa, Praetors' Voice precon, restrict the deck to its cards, or ignore it for a fully optimized build?
...
- [catalog slot=format row=format_unsupported_open fit=0.90 filled=false] I do not build Pauper. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=budget row=budget fit=0.90 filled=true] What is the most you want to spend on cards?
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] You have four dinosaur cards but want at least 30. Should I start with the cards you own and add a buy list, or use all available cards?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Your library is thin for this theme. Should I build around what you own and make a buy list, or use the whole pool?
...
- [catalog slot=commander row=commander fit=0.20 filled=true] Do you have a black-green commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, limit the deck to cards in your library, or ignore your library for a fully optimized deck?
...
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] Which approach do you want for the deck?
  - Options: Reanimate a single powerful creature / Build a repeatable value loop
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the Standard burn deck be: casual, FNM level, or tournament meta?
  - Options: Casual / FNM level / Tournament meta
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.90 filled=false] Should the deck keep Delver of Secrets, or may cards that do not fit the plan be cut?
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  - Options: Yes, the normal limits / No, I will say the limits
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the artifact prison deck be: casual, FNM level, or tournament-meta?
  - Options: Casual / FNM level / Tournament-meta
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for the deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=false] Which power bracket should the deck target: 2 (precon level), 3 (upgraded), or 4 (high power)?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=theme row=theme_competitive fit=0.90 filled=true] Would you like a specific competitive deck, or the best option within your budget?
  - Options: A named deck / The best deck under your budget
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=meta row=meta fit=0.90 filled=false] Should I keep the sideboard general, or would you like to name the decks you expect to face?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for?
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Your card pool is small for this theme. Should I prioritize cards you own and provide a buy list, or use the full pool?
  - Options: Owned-first with a buy list / Use the whole pool
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Do you want Karlov of the Ghost Counsel to lead the deck, or should it be one card among the other 99?
  - Options: As my commander / In the 99
...
- [catalog slot=theme row=theme_card_named fit=0.90 filled=true] What should the deck focus on: a creature type, a mechanic, or a play style?
- [catalog slot=commander row=commander_illegal fit=0.05 filled=true] Lightning Bolt can not lead a deck. Shall I suggest a commander instead?
  - Options: Yes, suggest one / No, I will name another
  - Refused as a reword (D-88): Lightning Bolt cannot lead a deck. Would you like me to suggest a legal commander instead?
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.20 filled=false] Should the deck keep every card you named, or may I cut cards that don't fit the burn plan?
  - Options: Keep every named card / Cut cards that don't fit
  - Refused as a reword (D-88): Should the deck keep Lightning Bolt?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target for someone new to the game?
  - Options: 1: Exhibition / 2: Core / 3: Upgraded / 4: Optimized / 5: cEDH
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I prioritize cards from your library, restrict the deck to your library, or ignore it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the land destruction deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a specific commander in mind, or should I suggest one for the deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Is there a budget for cards to buy?
...
- [catalog slot=pool_rule row=pool_precon fit=0.05 filled=true] Should I start with your Atraxa, Praetors' Voice precon, limit the deck to cards from it, or set it aside for a fully optimized build?
  - Options: Build from the precon / Use only the precon / Ignore the precon
...
- [catalog slot=format row=format_unsupported_open fit=0.05 filled=false] I do not build Pauper. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): What format should I build instead: Commander, Standard, or Modern?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a colorless commander in mind, or should I suggest one for the artifact deck?
  - Options: I have one in mind / Suggest one
...
- [catalog slot=format row=format fit=0.90 filled=true] Should this be a Commander deck?
  - Options: Commander
...
- [catalog slot=budget row=budget fit=0.90 filled=false] How much, if anything, would you like to spend on additional cards?
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the mono-red Modern Burn deck be: casual, FNM-level, or tournament-meta?
  - Options: Casual / FNM-level / Tournament-meta
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=theme row=theme_card_named fit=0.90 filled=true] What should the deck focus on: a creature type, a mechanic, or a play style?
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Should Atraxa, Praetors' Voice be your commander or one card in the 99?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which one do you want: Glissa Sunslayer, Yuna, Hope of Spira, or Gaius van Baelsar? Say "none" and I name three more.
  - Options: Glissa Sunslayer / Yuna, Hope of Spira / Gaius van Baelsar / None, name three more
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target?
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.20 filled=true] Which power level should the deck aim for? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 Exhibition / 2 Core / 3 Upgraded / 4 Optimized / 5 cEDH
  - Refused as a reword (D-88): Which power bracket should the deck target: 2 (precon level), 3 (upgraded), or 4 (high power)?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target?
  - Options: 1 Exhibition / 2 Core / 3 Upgraded / 4 Optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.20 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a black-green commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.90 filled=false] Should I build from your library first, use only cards from your library, or ignore your library for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [INVENTED slot=locked row=locked fit=0.20 filled=false] Should the deck keep Sol Ring, or may it be cut?
...
Slots the deck needs and nobody answered: format (asked, no answer), power (never asked).
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] Which of the two common plans for an artifacts-and-lifegain deck would you like?
...
**Turn 1, the user:** Build me an Eldrazi deck using only the cards in my library.
