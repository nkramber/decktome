...
|---|---|---|---|
| dinosaurs | 1 tag, 2 needles | 5 of 5 | 214 |
| dinosaur, before D-761 | none | 0 of 5 | 221 |
| dinosaur, after D-761 | 1 tag, 2 needles | 5 of 5 | 226 |
...
The shortlist still holds 266 cards and 40 lands. The on-theme count moves from 208 to 214. Six lands of rank 13 leave to make the room. Each one enters tapped unless a condition holds:

- Furycalm Snarl, Fortified Village, and Game Trail: the player reveals a land card of the right type from hand.
- Overgrown Farmland: the player controls two or more other lands.
