...
Verdict: FAIL. 30 of 30 gate conversations used catalog questions only. The bar is 25.

75 probe conversations ran beside the gate. They asked 303 questions, and the model offered 15 replacements. A probe explores catalog coverage and does not move the verdict (D-96).

1 conversations called themselves complete with a slot still unanswered, which fails the gate: another version after a build.
...
- Calls: 746. Time: 1165.1 seconds.
- Tokens: 745691 input (319220 cached), 65257 output.
- Cost: $0.1700.
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should the deck be built for: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should the deck use: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=theme row=theme fit=0.90 filled=true] What would you like the deck to do, such as use a creature type, mechanic, or play style?
- [catalog slot=house_rules row=house_rules fit=0.20 filled=true] When you say anything goes, do you mean any card with no ban list?
...
- [catalog slot=house_rules row=house_format_limits fit=0.20 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  ...
  - Refused as a reword (D-88): Are there any house rules beyond allowing any card with no ban list?
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the dragon deck be: casual, FNM level, or tournament-level?
...
- [catalog slot=budget row=budget_scope fit=0.05 filled=false] Is the $30 limit for the cards you buy, or for the deck's total value?
  - Options: The cards I buy / The whole deck
  - Refused as a reword (D-88): Is the $30 cap for the cards you buy, or for the whole deck value?
...
**PREMATURE.** It called itself complete with these slots unanswered: format (never asked), theme (never asked), colors (never asked), power (never asked), pool_rule (never asked).

**Turn 1, the user:** Give me another version of that deck.

- [catalog slot=plan_variant row=variance fit=0.90 filled=true] Would you like the same plan with different cards, or a different plan in the same colors?
...
Slots the deck needs and nobody answered: format (never asked), theme (never asked), colors (never asked), power (never asked).

**Turn 1, the user:** Switch to owned-only.

- [catalog slot=plan_variant row=variance fit=0.90 filled=false] Would you like to keep the same plan with different cards, or use a different plan in the same colors?
  - Options: Same plan, different cards / A different plan
...
- [catalog slot=budget row=budget fit=0.90 filled=false] What budget do you have for buying cards?
...
- [catalog slot=format row=format_unsupported_open fit=0.90 filled=false] I do not build Pauper. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.20 filled=true] Do you have a maximum budget for cards to buy?
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] You have four Dinosaur cards available, but the deck needs at least 30. Should I prioritize cards you own and add a buy list, or use the entire pool?
  - Options: Owned-first, then a buy list / Use the whole pool
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with cards from your library, use only cards from your library, or ignore your library for the deck?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a blue-red commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=budget row=budget_scope fit=0.50 filled=true] Is your budget a cap on the cards you buy, or on the value of the whole deck?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format does Friday's event use: Standard, Modern, or Commander?
  - Options: Standard / Modern / Commander
- [catalog slot=theme row=theme_competitive fit=0.90 filled=true] Would you prefer a specific top-tier deck, or the strongest option within your budget?
...
- [catalog slot=budget row=budget fit=0.20 filled=true] What is your budget for cards to buy?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.90 filled=false] Must the deck keep Delver of Secrets, or may cards that do not fit the tempo plan be cut?
...
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=meta row=meta fit=0.20 filled=true] Should I keep the sideboard general, or will you name the decks you expect to face?
  - Options: Keep the sideboard general / I’ll name the decks I expect to face
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target?
  - Options: 1: Exhibition / 2: Core / 3: Upgraded / 4: Optimized / 5: cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Since your card pool is limited for this theme, should I prioritize cards you own and include a buy list, or use the entire available pool?
  - Options: Owned first, with a buy list / Use the whole pool
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for the dragon deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the dragon deck target: 2 (precon level), 3 (upgraded), or 4 (high power)?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the dragon deck?
...
- [catalog slot=budget row=budget_scope fit=0.90 filled=false] Is your $50 maximum for the cards you buy, or for the deck's total value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Do you want Karlov of the Ghost Counsel to lead the deck, or should it be one card in the 99?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target? Level 2 is precon-level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=power row=power_commander fit=0.20 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
  - Refused as a reword (D-88): Should the deck target bracket 2 (precon level), bracket 3 (upgraded), or bracket 4 (high power)?
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which one do you want: Atarka, World Render, Thrakkus the Butcher, or Klauth, Unrivaled Ancient? Say "none" and I name three more.
  - Options: Atarka, World Render / Thrakkus the Butcher / Klauth, Unrivaled Ancient / None, name three more
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the Commander deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] For the land-destruction deck, should I use your library first, only your library, or ignore it for a fully optimized build?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for the red Dragon deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=false] Is there a budget for cards to buy?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the Karlov lifegain deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only cards from it, or ignore it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
- [catalog slot=budget row=budget_scope fit=0.20 filled=true] Does your budget cap apply to the cards you buy or to the whole deck's value?
  - Options: Cards I buy / The whole deck
  - Refused as a reword (D-88): Is your $100 budget a cap on the cards you buy, or on the whole deck value?
  - The guard compared against: Is that a cap on the cards you buy, or on the whole deck value?
...
- [catalog slot=format row=format fit=0.20 filled=true] Which format would you like for the deck: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind for the colorless artifact deck, or should I suggest one?
  - Options: I have one in mind / Suggest one
...
- [catalog slot=commander row=commander_pick fit=0.20 filled=false] Which one do you want: Old Man Willow, Killmonger, Scourge of Wakanda, or Jenova, Ancient Calamity? Say "none" and I name three more.
  ...
  - Refused as a reword (D-88): Which commander do you want: Old Man Willow, Killmonger, Scourge of Wakanda, or Jenova, Ancient Calamity? Say "none" and I’ll name three more.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the chaos deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the enchantress deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a black-green commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.90 filled=false] Should I use your library first, only cards from your library, or ignore it for the deck?
  - Options: Library first / Only my library / Ignore my library
- [catalog slot=budget row=budget_scope fit=0.20 filled=false] Does your budget cap apply to the cards you buy or to the whole deck's value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [INVENTED slot=locked row=locked fit=0.20 filled=false] Should the deck keep Sol Ring, or may it be cut if it does not fit the plan?
  - Options: Keep every card I named / Cut what does not fit
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the Modern mono-black aggro deck be: casual, FNM level, or tournament meta?
  - Options: Casual / FNM level / Tournament meta
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [INVENTED slot=plan_variant row=plan_choice fit=0.20 filled=false] Which direction would you like for the artifacts-and-lifegain theme?
