...
Run date: 2026-09-02. Card snapshot: 2026-09-02. Model: 20260902T221054Z.
...
Thresholds: -2.837, -2.317, -1.780, 1.459. Loss: 0.761 over 3000 iterations. Defect detector accuracy on the holdout: 0.97, at a cut of 0.46.
...
Thresholds: -5.086, -4.814, 1.418. Loss: 0.528 over 3000 iterations. Defect detector accuracy on the holdout: 0.99, at a cut of 0.28.
...
| Feature | Mean | Std | Weight |
|---|---|---|---|
| `card_rate` | 0.063 | 0.050 | +0.701 |
| `unseen_share` | 0.273 | 0.435 | -1.696 |
| `synergy` | 1.417 | 1.045 | +0.983 |
| `land` | 21.822 | 2.935 | +0.085 |
| `avg_mana_value` | 2.787 | 0.946 | -0.205 |
| `color_sources` | 0.988 | 0.312 | +0.003 |
| `tapped_share` | 0.117 | 0.134 | +0.060 |
| `mana_turn_four` | 3.867 | 0.808 | +0.113 |
| `hands_two_to_four_lands` | 0.737 | 0.054 | -0.003 |
| `curve_low` | 0.573 | 0.230 | +0.159 |
| `curve_high` | 0.182 | 0.154 | -0.024 |
| `ramp` | 5.300 | 6.946 | +0.057 |
| `draw` | 4.793 | 4.910 | +0.005 |
| `removal` | 7.324 | 4.367 | -0.015 |
| `wipe` | 0.937 | 1.683 | +0.075 |
| `interaction` | 2.945 | 3.779 | +0.109 |
| `empty_roles` | 1.066 | 0.848 | +0.036 |
| `fast_mana` | 0.474 | 1.403 | -0.030 |
| `game_changer` | 0.273 | 0.893 | -0.137 |
| `playset_share` | 0.554 | 0.237 | -0.472 |
| `singleton_share` | 0.145 | 0.140 | -0.550 |
| `source_spread` | 0.228 | 0.202 | -0.126 |

Thresholds: -3.714, -2.014, 3.550. Loss: 0.508 over 3000 iterations. Defect detector accuracy on the holdout: 0.97, at a cut of 0.50.
...
Verdict: FAIL. Time: 41 seconds, no provider call. Failed bars: commander: precon over bad 0.94 of 18480 (bar 0.95); modern: precon over bad 0.95 of 18605 (bar 0.95).
