...
Run date: 2026-09-02. Card snapshot: 2026-09-02. Model: 20260902T220112Z.

## Separation on the holdout

| Format | Lists | Used | Synthetic | Holdout | Great over precon | Precon over bad | Accuracy |
|---|---|---|---|---|---|---|---|
| commander | 21538 | 8388 | 1940 | 2150 | 0.75 of 20000 (bar 0.90) | 0.87 of 18480 (bar 0.95) | 0.38 |
| standard | 3316 | 3313 | 40 | 666 | 0.71 of 147 (bar 0.90) | 1.00 of 5 (bar 0.95) | 0.26 |
| modern | 8745 | 5407 | 1635 | 1420 | 0.97 of 13908 (bar 0.90) | 0.81 of 18605 (bar 0.95) | 0.46 |
...
Thresholds: -2.761, -2.284, -1.781, 1.417. Loss: 0.774 over 3000 iterations. Defect detector accuracy on the holdout: 0.93.

Confusion on the holdout, rows are the label and columns the grade, worst first:

- bad: [419 0 0 1 0]
- baseline: [27 0 0 17 0]
- typical: [25 0 0 14 1]
- good: [478 0 0 102 234]
- great: [457 0 0 89 286]
...
Thresholds: -5.086, -4.813, 1.419. Loss: 0.528 over 3000 iterations. Defect detector accuracy on the holdout: 0.83.
...
Thresholds: -3.684, -2.053, 3.482. Loss: 0.522 over 3000 iterations. Defect detector accuracy on the holdout: 0.83.
...
Verdict: FAIL. Time: 39 seconds, no provider call. Failed bars: commander: great over precon 0.75 of 20000 (bar 0.90); commander: precon over bad 0.87 of 18480 (bar 0.95); standard: great over precon 0.71 of 147 (bar 0.90); modern: precon over bad 0.81 of 18605 (bar 0.95).
