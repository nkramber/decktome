...
75 probe conversations ran beside the gate. They asked 298 questions, and the model offered 9 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
- Calls: 732. Time: 1193.4 seconds.
- Tokens: 714063 input (301762 cached), 64060 output.
- Cost: $0.1654.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Level 2 is precon-level, 3 is upgraded, and 4 is high power.
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] The available card pool is small for this theme. Should I build owned-first with a buy list, or use the whole pool?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which 60-card format should the deck use: Standard or Modern?
...
- [INVENTED slot=house_rules row=house_rules fit=0.20 filled=true] When you say anything goes, do you mean any card with no ban list?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format is the event running: Standard, Modern, or Commander?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for a white-black deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [INVENTED slot=power row=power_commander fit=0.20 filled=true] For the low-power build, should I aim for around precon level or somewhat upgraded?
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
...
- [catalog slot=pool_rule row=pool_thin fit=0.05 filled=true] You have four dinosaur cards, but the deck needs at least 30. Should I start with the cards you own and add a buy list, or use the entire pool?
  - Options: Start with owned cards and add a buy list / Use the entire pool
  - Refused as a reword (D-88): Your library holds 4 dinosaur cards. Should I build owned-first with a buy list, or use the whole pool?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a white-blue commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.50 filled=false] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=pool_rule row=pool fit=0.05 filled=true] Should I start with your library, use only your library, or ignore it for a fully optimized deck?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck use your library first, only cards from your library, or can it be fully optimized without considering your library?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the Standard deck be: casual, FNM level, or tournament meta?
  - Options: Casual / FNM level / Tournament meta
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.20 filled=true] What budget do you have for buying cards?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [INVENTED slot=locked row=locked fit=0.20 filled=false] Should the deck keep Delver of Secrets, or may other cards be cut if they do not fit the plan?
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  - Options: Yes, the normal limits / No, I will say the limits
- [catalog slot=power row=power_sixty fit=0.90 filled=false] How strong should the artifact prison deck be?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Since the card pool is limited for this theme, should the deck prioritize cards you own and include a buy list, or use the entire pool?
  - Options: Use what you own first, with a buy list / Use the entire card pool
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for any cards you’d need to buy?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I prioritize cards from your library, use only cards from your library, or build without considering it?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=deck_count row=one_deck fit=0.05 filled=true] I build one deck at a time. Which deck do you want first?
  - Refused as a reword (D-88): I can help with two decks. Which one do you want to work on first: Commander or Modern?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library as a starting point, restrict the deck to it, or ignore it for a fully optimized build?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=pool_rule row=pool fit=0.20 filled=true] Should I build from your library first, use only cards from your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
  - Refused as a reword (D-88): Should I build from your library first, use only your library, or ignore your library for a fully optimized deck?
  - The guard compared against: Build from your library first, only your library, or ignore it for a fully optimized deck?
...
- [catalog slot=house_rules row=house_format_limits fit=0.05 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  - Options: Yes, the normal limits / No, I will say the limits
  - Refused as a reword (D-88): Within your house rules, are there any deck size or card-copy limits?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for the colorless artifact deck?
...
- [catalog slot=budget row=budget fit=0.50 filled=false] How much would you like to spend on additional cards?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.90 filled=false] Must the deck keep Sol Ring, or may I cut cards that do not fit the plan?
  - Options: Keep every card I named / Cut cards that do not fit the plan
...
- [catalog slot=commander row=commander fit=0.20 filled=false] Do you have a commander in mind, or should I suggest one for your blue-red spellslinger deck?
  - Options: I have one in mind / Suggest one
  - Refused as a reword (D-88): Do you have an Oathbreaker in mind, or should I suggest one?
