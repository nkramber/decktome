...
Run date: 2026-09-02. Card snapshot: 2026-09-02. Model: 20260902T220759Z.
...
| modern | 8745 | 5407 | 1635 | 1420 | 1.00 of 13908 (bar 0.90) | 0.86 of 18605 (bar 0.95) | 0.80 |
...
| Feature | Mean | Std | Weight |
|---|---|---|---|
| `card_rate` | 0.118 | 0.052 | +0.502 |
| `unseen_share` | 0.012 | 0.102 | -0.618 |
| `synergy` | 1.720 | 0.668 | +0.311 |
| `land` | 23.159 | 2.249 | -0.000 |
| `avg_mana_value` | 2.551 | 0.574 | -0.054 |
| `color_sources` | 1.080 | 0.419 | +0.113 |
| `tapped_share` | 0.029 | 0.064 | +0.043 |
| `mana_turn_four` | 4.109 | 0.766 | -0.123 |
| `hands_two_to_four_lands` | 0.760 | 0.026 | +0.116 |
| `curve_low` | 0.628 | 0.165 | -0.136 |
| `curve_high` | 0.122 | 0.121 | -0.005 |
| `ramp` | 5.248 | 6.465 | +0.001 |
| `draw` | 4.823 | 3.327 | +0.043 |
| `removal` | 8.057 | 4.416 | +0.039 |
| `wipe` | 1.384 | 1.729 | -0.072 |
| `interaction` | 3.709 | 2.944 | +0.069 |
| `empty_roles` | 0.766 | 0.695 | -0.010 |
| `fast_mana` | 0.065 | 0.520 | -0.006 |
| `playset_share` | 0.602 | 0.171 | +0.082 |
| `singleton_share` | 0.079 | 0.061 | +0.008 |
| `source_spread` | 0.280 | 0.219 | +0.015 |

Thresholds: -5.086, -4.813, 1.418. Loss: 0.528 over 3000 iterations. Defect detector accuracy on the holdout: 0.99.
...
| Feature | Mean | Std | Weight |
|---|---|---|---|
| `card_rate` | 0.063 | 0.050 | +0.703 |
| `unseen_share` | 0.274 | 0.436 | -1.649 |
| `synergy` | 1.417 | 1.045 | +0.949 |
| `land` | 21.822 | 2.935 | +0.075 |
| `avg_mana_value` | 2.779 | 0.940 | -0.201 |
| `color_sources` | 0.989 | 0.310 | +0.004 |
| `tapped_share` | 0.116 | 0.134 | +0.059 |
| `mana_turn_four` | 3.869 | 0.808 | +0.091 |
| `hands_two_to_four_lands` | 0.736 | 0.054 | +0.033 |
| `curve_low` | 0.574 | 0.229 | +0.134 |
| `curve_high` | 0.180 | 0.153 | -0.025 |
| `ramp` | 5.292 | 6.954 | +0.077 |
| `draw` | 4.740 | 4.918 | -0.003 |
| `removal` | 7.289 | 4.341 | -0.006 |
| `wipe` | 0.926 | 1.676 | +0.088 |
| `interaction` | 2.921 | 3.776 | +0.133 |
| `empty_roles` | 1.079 | 0.848 | -0.002 |
| `fast_mana` | 0.471 | 1.401 | -0.022 |
| `game_changer` | 0.273 | 0.893 | -0.107 |
| `playset_share` | 0.536 | 0.263 | -0.263 |
| `singleton_share` | 0.145 | 0.140 | -0.448 |
| `source_spread` | 0.228 | 0.202 | -0.119 |

Thresholds: -3.706, -2.030, 3.521. Loss: 0.516 over 3000 iterations. Defect detector accuracy on the holdout: 0.94.
...
Verdict: FAIL. Time: 41 seconds, no provider call. Failed bars: commander: precon over bad 0.94 of 18480 (bar 0.95); modern: precon over bad 0.86 of 18605 (bar 0.95).
