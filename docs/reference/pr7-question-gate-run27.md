...
74 probe conversations ran beside the gate. They asked 280 questions, and the model offered 8 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
- Calls: 665. Time: 1156.4 seconds.
- Tokens: 745803 input (343140 cached), 63407 output.
- Cost: $0.1635.
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Which commander do you want? Name one, or I can suggest three.
  - Options: Suggest one
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Which white-blue commander do you want? Name one, or I can suggest three.
  - Options: Suggest one
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Do you want Grist, the Hunger Tide as your commander or as one card in the 99?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Level 2 is near a preconstructed deck, level 3 is upgraded, and level 4 is high power.
  - Options: 1 — exhibition / 2 — core / 3 — upgraded / 4 — optimized / 5 — cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] The available pool is thin for this theme. Should I build from what you own first with a buy list, or use the whole pool?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Bracket 2 is near a preconstructed deck, 3 is upgraded, and 4 is high power.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have an unusual commander in mind, or should I suggest one?
  - Options: Suggest one

**Turn 3, the user:** A sacrifice deck. Bracket 2, and any colors are fine.

- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library first, limit the deck to cards from your library, or ignore your library for a fully optimized deck?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format do you want for the 60-card deck: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
...
- [catalog slot=house_rules row=house_format_limits fit=0.20 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  ...
  - Refused as a reword (D-88): Do the normal 60-card deck limits hold?

**Turn 2, the user:** Any card, no ban list. Call it Modern. A dragon deck.

- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the dragon deck be?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format does the event run: Standard, Modern, or Commander?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should the mill deck use?
  - Options: Commander / Standard / Modern
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest three blue-black options?
  - Options: Suggest one
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is near a preconstructed deck, 3 is upgraded, and 4 is high power.
  - Options: 1 — exhibition / 2 — core / 3 — upgraded / 4 — optimized / 5 — cEDH
- [catalog slot=commander row=commander fit=0.90 filled=true] Which white-black commander do you want? Name one, or I can suggest three.
  - Options: Suggest one
...
- [catalog slot=commander row=commander_pick fit=0.35 filled=false] Which one do you want: Vito, Thorn of the Dusk Rose, Heliod, Sun-Crowned, or Haliya, Guided by Light? Say "none" and I name three more.
...
- [catalog slot=pool_rule row=pool_precon fit=0.90 filled=true] Should I start with the precon, limit the deck to cards from it, or build without it?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Which commander would you like for your Dinosaur deck? Name one, or I can suggest one.
  - Options: Suggest one

**Turn 3, the user:** Gishath, Sun's Avatar is the commander. Bracket 2, red green and white.

- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] You have four Dinosaur cards, so there aren’t enough to reach 30. Should I start with the cards you own and add a buy list, or use the entire pool?
  - Options: Start with owned cards and add a buy list / Use the entire card pool
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [INVENTED slot=pool_rule row=pool_thin fit=0.20 filled=true] Should I prioritize the cards you own and provide a buy list, or use the whole pool?
  - Options: Owned-first with a buy list / Use the whole pool
  - It replaced: Your library is thin for this theme. Build owned-first with a buy list, or use the whole pool?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest three?
  - Options: Suggest one

**Turn 2, the user:** Commander. Red and green.

- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck use cards from your library first, only cards from your library, or ignore your library for a fully optimized build?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a white-blue commander in mind, or should I suggest three?
  - Options: Suggest one
...
- [catalog slot=format row=format_unsupported_open fit=0.20 filled=false] I do not build Legacy. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): I can’t build Legacy. Which format should I build instead: Commander, Standard, or Modern?
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only cards from it, or ignore it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
- [INVENTED slot=commander row=commander fit=0.20 filled=true] Do you have a black-green commander in mind, or should I suggest three?
  - Options: Suggest three
  - It replaced: Which commander do you want? Name one, or I suggest three.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind for the reanimator deck, or should I suggest one?
  - Options: Suggest one
...
- [catalog slot=budget row=budget_scope fit=0.90 filled=true] Do you mean a limit on the cards you purchase or on the deck's total value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format does FNM run: Standard, Modern, or Commander?
  - Options: Standard / Modern / Commander
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How competitive should the Standard deck be: casual, FNM-level, or tournament-level?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: 2 (near a precon), 3 (upgraded), or 4 (high power)? Choose 1 for exhibition, 5 for cEDH, or one of the levels in between.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target? Choose a level from 1 to 5.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Should I prioritize cards you already own and provide a buy list, or use the whole pool?
  - Options: Owned-first with a buy list / Use the whole pool
- [catalog slot=commander row=commander fit=0.90 filled=true] Would you like me to suggest a commander, or do you have one in mind?
  - Options: Suggest one
...
- [catalog slot=theme row=theme fit=0.90 filled=true] What should the deck do: center on a creature type, mechanic, or play style?
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Which commander do you want for your red-green dragon deck? Name one, or I suggest three.
  - Options: Suggest three
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the Commander dragon deck aim for? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the dragon deck?
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Which commander would you like for the dragon deck? Name one, or I can suggest one.
  - Options: Suggest one
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should the Karlov of the Ghost Counsel deck use? Choose Commander, Standard, or Modern.
  - Options: Commander / Standard / Modern
- [catalog slot=theme row=theme fit=0.90 filled=true] What should the deck focus on: a creature type, a mechanic, or a play style?
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Do you want Karlov of the Ghost Counsel to lead the deck, or should it be one card in the 99?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Level 2 is near a preconstructed deck, level 3 is upgraded, and level 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use cards from your library first, use only cards from your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Bracket 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 — exhibition / 2 — core / 3 — upgraded / 4 — optimized / 5 — cEDH
- [catalog slot=commander row=commander fit=0.90 filled=false] Which black commander do you want for the zombie deck? Name one, or I can suggest three.
  - Options: Suggest one
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=false] Inside your house format, do the normal 60-card deck limits hold?
  - Options: Yes, the normal limits / No, I will say the limits
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?

**Turn 3, the user:** Fine, treat it as Commander. A dragon deck, red.

- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the dragon deck target?
  - Options: 1 — exhibition / 2 — core, near a precon / 3 — upgraded / 4 — high power / 5 — cEDH
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a red dragon commander in mind, or should I suggest three?
  - Options: Suggest three
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library first, use only your library, or not use it for the deck?
  - Options: Use my library first / Use only my library / Don't use my library
...
- [catalog slot=theme row=theme fit=0.90 filled=true] What should the Modern deck do: a creature type, a mechanic, or a play style?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is near a preconstructed deck, 3 is upgraded, and 4 is high power.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind for a deck built around big green creatures, or should I suggest three?
  - Options: Suggest one
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Which blue-black commander do you want? Name one, or I can suggest three.
  - Options: Suggest three
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the land destruction deck target? Level 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=commander row=commander fit=0.90 filled=true] Which commander do you want for the land destruction deck? Name one, or I can suggest three.
  - Options: Suggest one

**Turn 2, the user:** Red and green.

- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only cards from it, or build without using it?
  - Options: Use my library first / Use only my library / Build without using my library
...
- [catalog slot=theme row=theme fit=0.90 filled=true] What should the deck do? Name a creature type, mechanic, or play style.
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Level 2 is near a precon, level 3 is upgraded, and level 4 is high power.
  - Options: 1 Exhibition / 2 Core / 3 Upgraded / 4 Optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with cards from your library, use only cards from it, or optimize the deck without checking it?
  - Options: Start with my library / Use only my library / Optimize without my library
- [INVENTED slot=commander row=commander fit=0.20 filled=true] Which commander should lead the deck? Name one, or I can suggest three options for a black-green sacrifice deck.
  - Options: Suggest three commanders
  - It replaced: Which commander do you want? Name one, or I suggest three.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for? 2 is near a preconstructed deck, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a red-green commander in mind, or should I suggest three?
  - Options: Suggest one
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the red Commander dragon deck target? 2 is the core level, near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
...
- [catalog slot=pool_rule row=pool_precon fit=0.05 filled=true] Should I start with the precon, limit the deck to its cards, or build without using it?
  - Options: Start with the precon / Use only cards from the precon / Build without the precon
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Which black commander do you want? Name one, or I suggest one.
  - Options: Suggest one
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target: 2, near a preconstructed deck; 3, upgraded; 4, high power; or another level?
  - Options: 1: Exhibition / 2: Core / 3: Upgraded / 4: Optimized / 5: cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck use your card library first, only cards from your library, or disregard it for a fully optimized build?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for buying cards beyond your library?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the Commander deck target? Choose from 1 (exhibition), 2 (core, near a preconstructed deck), 3 (upgraded), 4 (optimized), or 5 (cEDH).
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or build without using your library?
  - Options: Use my library first / Use only my library / Build without using my library
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is the core level, near a precon; 3 is upgraded; 4 is high power.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=true] Which commander do you want? Name one, or I can suggest three colorless options.
  - Options: Suggest one
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Which colorless commander do you want? Name one, or I suggest one.
  - Options: Suggest one
...
- [INVENTED slot=budget row=budget fit=0.20 filled=false] What budget should I use for the cards?
...
- [catalog slot=theme row=theme fit=0.90 filled=false] What should the deck focus on beyond being cEDH: a creature type, a mechanic, or a play style?
- [catalog slot=budget row=budget fit=0.90 filled=true] Is there a budget for cards to buy?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is core level, near a precon; 3 is upgraded; 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=power row=power_commander fit=0.90 filled=false] Which power bracket should the deck target? You mentioned 2 or 3; choose one.
  - Options: Bracket 1 / Bracket 2 / Bracket 3 / Bracket 4 / Bracket 5
- [catalog slot=budget row=budget fit=0.90 filled=false] How much would you like to spend on cards you don't already own?
- [catalog slot=commander row=commander_pick fit=0.20 filled=false] Which one do you want: Old Man Willow, Killmonger, Scourge of Wakanda, or Jenova, Ancient Calamity? Say "none" and I name three more.
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=true] Which commander would you like to use for the deck? Name one, or I can suggest three.
  - Options: Suggest one
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should the Atraxa, Praetor's Voice deck use: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?

**Turn 2, the user:** I meant Atraxa, Praetors' Voice. Commander, superfriends.

- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? Choose 2 for a level near a precon, 3 for upgraded, or 4 for high power.
  - Options: 1: exhibition / 2: core / 3: upgraded / 4: optimized / 5: cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is the core level, near a preconstructed deck; 3 is upgraded; 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the chaos deck aim for? 2 is near a preconstructed deck, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the chaos deck?
- [catalog slot=budget row=budget fit=0.90 filled=true] What budget should the deck stay within for cards you need to buy?
...
- [catalog slot=commander row=commander_pick fit=0.35 filled=true] Which one do you want: Mole Man, Moloid Master, Ka-Zar of the Savage Land, or Toph, the Blind Bandit? Say "none" and I name three more.
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Is there a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=false] Which green commander do you want? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=commander row=commander_pick fit=0.35 filled=false] Which one do you want: Arahbo, Roar of the World, Kaheera, the Orphanguard, or Kutzil, Malamet Exemplar? Say "none" and I name three more.
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=false] Should I build from your library first, use only cards from your library, or ignore it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
- [catalog slot=budget row=budget_scope fit=0.90 filled=false] Does your budget cap the cards you buy, or the value of the whole deck?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Is there a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=false] Which commander do you want for the deck? Name one, or I suggest three.
  - Options: Suggest one

**Turn 3, the user:** Bracket 3, and 200 dollars.

- [catalog slot=commander row=commander_pick fit=0.35 filled=false] Which one do you want: Itzquinth, Firstborn of Gishath, Owen Grady, Raptor Trainer, or Etali, Primal Conqueror // Etali, Primal Sickness? Say "none" and I name three more.
  - Options: Itzquinth, Firstborn of Gishath / Owen Grady, Raptor Trainer / Etali, Primal Conqueror // Etali, Primal Sickness / None, name three more
...
- [catalog slot=budget row=budget fit=0.90 filled=false] Is there a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.90 filled=false] Which commander do you want for your white-blue blink deck? Name one, or I suggest three.
  - Options: Suggest one
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for? Level 2 is near a preconstructed deck, level 3 is upgraded, and level 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=commander row=commander fit=0.50 filled=false] Do you have a blue-red commander in mind, or should I suggest one?
  - Options: Suggest one
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the Commander mill deck target? 2 is the core level, near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the deck?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the stax Commander deck target? 2 is the core level, near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for the stax Commander deck?
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy for the stax Commander deck?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Which black-green commander do you want? Name one, or I suggest one.
  - Options: Suggest one
