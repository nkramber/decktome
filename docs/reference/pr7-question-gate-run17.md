...
74 probe conversations ran beside the gate. They asked 264 questions, and the model offered 24 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
- Calls: 680. Time: 1169.1 seconds.
- Tokens: 661580 input (287714 cached), 61247 output.
- Cost: $0.1540.
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=power row=jank fit=0.90 filled=true] When you say “janky,” do you mean a low-power deck, an odd card nobody expects, or a plan that almost never works?
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] Should the deck use the usual 60-card minimum, four-copy limit, and 15-card sideboard, or would you like to set different limits?
  - Options: Yes, the normal limits / No, I will say the limits
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong would you like the deck to be?
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I aim for tournament-level power, or would you prefer FNM-level or casual power?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format is the FNM on Friday: Standard, Modern, or Commander?
...
- [catalog slot=format row=format_unsupported_open fit=0.05 filled=false] I do not build Pioneer. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): I do not build Pioneer. Which format should I build instead: Commander, Standard, or Modern?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the Brago blink deck target? Choose 1 for exhibition, 2 for core, 3 for upgraded, 4 for optimized, or 5 for cEDH.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=commander_pick fit=0.05 filled=true] Which one do you want: Aerith Gainsborough, Dina, Soul Steeper, or Celestine, the Living Saint? Say "none" and I name three more.
  ...
  - Refused as a reword (D-88): Which commander would you like: Aerith Gainsborough, Dina, Soul Steeper, Celestine, the Living Saint, or a different one?
...
- [catalog slot=power row=power_sixty_confirm fit=0.50 filled=true] Should I build for tournament-level competition?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=pool_rule row=pool_precon fit=0.05 filled=true] Should I start with your precon, restrict the deck to cards from it, or ignore it and build without that card pool?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [INVENTED slot=power row=power_commander fit=0.20 filled=true] Should the deck target low power, or would you prefer a different power level?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] For this house format, should the deck use a 60-card minimum, up to four copies of each card name, and a 15-card sideboard?
...
- [catalog slot=commander row=commander fit=0.20 filled=true] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
  - Refused as a reword (D-88): Do you have a commander in mind, or should I suggest one other than Grist, the Hunger Tide?
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
- [INVENTED slot=locked row=locked fit=0.20 filled=false] Should Grist, the Hunger Tide be included in the 99, or may the deck omit Grist entirely?
  - Options: Keep every card I named / Cut what does not fit
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a blue-red commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=budget row=budget_scope fit=0.05 filled=true] Is your budget a cap on the cards you buy, or on the deck's total value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build for tournament-level competition, FNM-level competition, or casual play?
  - Options: Yes, tournament level / No, FNM level / No, casual
...
- [catalog slot=theme row=theme_competitive fit=0.90 filled=true] For the event, do you want a named top-tier deck or the best deck under your budget?
  - Options: A named deck / The best deck under budget
- [INVENTED slot=power row=power_sixty_confirm fit=0.20 filled=true] Should the deck target competitive tournament level, FNM level, or casual play?
  - Options: Yes, tournament level / No, FNM level / No, casual
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] For your house format, should the deck use a 60-card minimum, up to four copies of each name, and a 15-card sideboard?
  - Options: Yes, use the normal limits / No, I’ll specify the limits
...
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to face so I can tune the 15-card sideboard to them?
...
- [catalog slot=theme row=theme_competitive fit=0.90 filled=true] Would you prefer a specific named deck, or the strongest option that fits your $50 budget?
  - Options: A named deck / The best deck under budget
- [INVENTED slot=power row=power_sixty_confirm fit=0.20 filled=true] Should I aim for tournament-level play within your $50 budget?
  - Options: Yes, tournament level / No, FNM level / No, casual
  - It replaced: You asked for a competitive deck, so I will build to tournament level. Is that right?
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the dragon deck target?
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=theme row=theme_card_named fit=0.90 filled=true] What should the deck do beyond being built around Karlov of the Ghost Counsel: focus on a creature type, a mechanic, or a play style?
...
- [catalog slot=commander row=named_card_role fit=0.20 filled=false] Should Karlov of the Ghost Council lead the deck, or be included as one of the other cards?
  - Options: As my commander / In the 99
  - Refused as a reword (D-88): Do you want Karlov of the Ghost Council as your commander, or as one card in the 99?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with cards from your library, use only cards from it, or build without it?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.05 filled=false] Do you have a black commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_sixty fit=0.50 filled=true] How strong should the sideboard plan be: casual, FNM level, or tournament-meta?
  - Options: Casual / FNM / Tournament-meta
...
- [catalog slot=deck_count row=one_deck fit=0.05 filled=false] I build one deck at a time. Which deck do you want first?
  - Refused as a reword (D-88): Which deck do you want to work on first: Commander or Modern?
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which one do you want: Hope Estheim, The Mouth of Sauron, or Saruman of Many Colors? Say "none" and I name three more.
  - Options: Hope Estheim / The Mouth of Sauron / Saruman of Many Colors / None, name three more
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: 2 (precon level), 3 (upgraded), or 4 (high power)? You can also choose 1 (exhibition) or 5 (cEDH).
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=locked row=locked fit=0.90 filled=false] Do you want to keep every card you named, or may I cut cards that do not fit the sacrifice plan?
  - Options: Keep every card I named / Cut what does not fit
...
- [catalog slot=pool_rule row=pool_precon fit=0.20 filled=true] Should I start with your precon, restrict the deck to cards from it, or build without using it?
...
- [catalog slot=power row=power_sixty_confirm fit=0.20 filled=true] Should I build the deck for tournament-level competition?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to face so I can tune the sideboard?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the lifegain deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, restrict the deck to your library, or ignore your library for a fully optimized build?
  - Options: Use my library first / Use only my library / Ignore my library
- [catalog slot=locked row=locked fit=0.20 filled=false] Should Sanguine Bond and any other cards you name stay in the deck, or may I cut cards that do not fit the plan?
...
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to play against? I tune the 15 sideboard cards to that.
...
- [INVENTED slot=power row=power_sixty_confirm fit=0.05 filled=false] Are you aiming for tournament-level competitiveness, FNM-level play, or a casual deck?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [INVENTED slot=colors row=colors fit=0.20 filled=true] What color preference should the deck have?
...
- [INVENTED slot=budget row=budget fit=0.20 filled=false] How much should I spend on cards?
...
- [catalog slot=commander row=commander_pick fit=0.05 filled=false] Which one do you want: Jenova, Ancient Calamity, Shelob, Child of Ungoliant, or The Serpent Society? Say "none" and I name three more.
  ...
  - Refused as a reword (D-88): Which commander do you want: Jenova, Ancient Calamity; Shelob, Child of Ungoliant; or The Serpent Society? Say "none" and I’ll name three more.
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should this Modern deck be?
  - Options: Casual / FNM level / Tournament meta
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Do you want Atraxa, Praetor's Voice as your commander, or as one card in the 99?
  - Options: Use Atraxa, Praetors' Voice as my commander / Include Atraxa, Praetors' Voice in the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should the deck be: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the landfall deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.90 filled=false] Should I use your library first, limit the deck to your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=format row=format_unsupported_open fit=0.20 filled=false] I do not build Pauper Commander. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): I do not build Pauper Commander. Which format should I build instead: Commander, Standard, or Modern?
...
- [catalog slot=commander row=commander fit=0.05 filled=false] Do you have a commander in mind, or should I suggest one for your blue-red spellslinger deck?
  - Options: I have one in mind / Suggest one
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the mono-black aggro deck be: casual, FNM-level, or tournament-meta?
  - Options: Casual / FNM-level / Tournament-meta
...
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] For your white-blue artifacts and lifegain deck, which plan do you want to emphasize?
