...
Run date: 2026-09-02. Card snapshot: 2026-09-02. Model: 20260902T215748Z.

## Separation on the holdout

| Format | Lists | Used | Synthetic | Holdout | Great over precon | Precon over bad | Accuracy |
|---|---|---|---|---|---|---|---|
| commander | 21538 | 8388 | 1940 | 2150 | 0.98 of 20000 (bar 0.90) | 0.74 of 18480 (bar 0.95) | 0.56 |
| standard | 3316 | 3313 | 40 | 666 | 1.00 of 147 (bar 0.90) | 1.00 of 5 (bar 0.95) | 0.78 |
| modern | 8745 | 5407 | 1635 | 1420 | 1.00 of 13908 (bar 0.90) | 0.70 of 18605 (bar 0.95) | 0.80 |
...
|---|---|---|---|
| Elesh Norn, Grand Cenobite | 1.00 | 1 | 1 |
| Bristly Bill, Spine Sower | 1.00 | 2 | 2 |
| Sakashima of a Thousand Faces | 1.00 | 1 | 1 |
...
Cards with a rate: 9633. Pairs that lift: 200000. Commanders with a signal: 573. Top lists shape: 27.5 lands at 2.19 over 3168 lists.
...
| `unseen_share` | 0.061 | 0.139 | -1.648 |
| `synergy` | 0.588 | 0.677 | +0.208 |
| `land` | 29.198 | 5.405 | -0.053 |
| `avg_mana_value` | 2.505 | 0.783 | -0.153 |
| `color_sources` | 1.252 | 0.305 | +0.246 |
| `tapped_share` | 0.074 | 0.097 | +0.303 |
| `mana_turn_four` | 4.911 | 0.597 | +0.274 |
| `hands_two_to_four_lands` | 0.627 | 0.081 | +0.047 |
| `curve_low` | 0.569 | 0.180 | +0.048 |
| `curve_high` | 0.116 | 0.121 | -0.158 |
| `ramp` | 19.746 | 7.188 | -0.136 |
| `draw` | 6.853 | 3.490 | -0.200 |
| `removal` | 5.790 | 3.391 | +0.021 |
| `wipe` | 1.218 | 1.631 | -0.180 |
| `interaction` | 8.362 | 4.658 | +0.185 |
| `empty_roles` | 0.043 | 0.211 | -0.036 |
| `fast_mana` | 7.124 | 4.753 | -0.057 |
| `game_changer` | 10.357 | 7.245 | +0.067 |
| `cedh_signal` | 0.377 | 0.189 | +0.257 |
| `high_bracket_share` | 0.175 | 0.274 | +0.200 |
| `commander_decks` | 3.806 | 4.773 | -0.448 |

Thresholds: -2.775, -2.300, -1.796, 1.426. Loss: 0.771 over 3000 iterations.
...
Thresholds: -5.086, -4.813, 1.419. Loss: 0.528 over 3000 iterations.
...
Thresholds: -3.684, -2.053, 3.482. Loss: 0.522 over 3000 iterations.
...
Verdict: FAIL. Time: 40 seconds, no provider call. Failed bars: commander: precon over bad 0.74 of 18480 (bar 0.95); modern: precon over bad 0.70 of 18605 (bar 0.95); offer: a commander comes from no top cut.
