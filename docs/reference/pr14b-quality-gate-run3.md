...
Run date: 2026-09-02. Card snapshot: 2026-09-02. Model: 20260902T220249Z.

## Separation on the holdout

| Format | Lists | Used | Synthetic | Holdout | Great over precon | Precon over bad | Accuracy |
|---|---|---|---|---|---|---|---|
| commander | 21538 | 8388 | 1940 | 2150 | 0.98 of 20000 (bar 0.90) | 0.79 of 18480 (bar 0.95) | 0.57 |
...
Thresholds: -2.761, -2.284, -1.781, 1.417. Loss: 0.774 over 3000 iterations. Defect detector accuracy on the holdout: 0.97.

Confusion on the holdout, rows are the label and columns the grade, worst first:

- bad: [414 0 0 6 0]
- baseline: [25 0 0 19 0]
- typical: [20 0 0 19 1]
- good: [34 0 0 291 489]
- great: [23 0 0 279 530]
...
Verdict: FAIL. Time: 43 seconds, no provider call. Failed bars: commander: precon over bad 0.79 of 18480 (bar 0.95); modern: precon over bad 0.76 of 18605 (bar 0.95).
