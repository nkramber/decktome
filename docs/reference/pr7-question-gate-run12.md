...
22 probe conversations ran beside the gate. They asked 88 questions, and the model offered 6 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
| Conversations | 30 |
| Questions asked | 137 |
| From the catalog | 134 |
| Invented by the model | 3 |
| Replacements refused as rewords | 5 |
| Catalog questions that closed a slot | 93 |
...
- Calls: 397. Time: 662.6 seconds.
- Tokens: 263026 input (0 cached), 35918 output.
- Cost: $0.0957.
...
- [catalog slot=commander row=commander fit=0.05 filled=true] Do you have a commander in mind, or should I suggest one for your white-black lifegain deck?
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which commander do you want: Aerith Gainsborough, Minwu, White Mage, or Cecil, Dark Knight // Cecil, Redeemed Paladin? Choose “None—name three more” and I’ll name three additional options.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Denethor, Ruling Steward, Gríma Wormtongue, or Old Man Willow? Say “none” and I’ll name three more.
...
- [INVENTED slot=format row=format fit=0.20 filled=true] Which format should the deck use, such as Commander, Standard, Modern, Pioneer, or Pauper?
  - Options: Commander / Standard / Modern / Pioneer / Pauper
  - It replaced: Which format: Commander, Standard, Modern, or something else?
- [catalog slot=theme row=theme fit=0.90 filled=true] What theme or play style should the deck have—such as a creature type, mechanic, or strategy?
- [catalog slot=house_rules row=house_rules fit=0.20 filled=true] When you say anything goes, do you mean any card with no ban list or Vintage rules?
  ...
  - Refused as a reword (D-88): What house rules should apply at your table: any card with no ban list, or Vintage rules?

**Turn 2, the user:** Any card, no ban list. Call it Modern. A dragon deck.

- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=false] For your house format, should the normal limits apply: a 60-card minimum, up to four copies of a card name, and a 15-card sideboard?
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format is your Friday FNM: Standard, Pioneer, Modern, or Pauper?
  - Options: Standard / Pioneer / Modern / Pauper
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have any color preference?

**Turn 2, the user:** Pioneer. The best deck under budget.

- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do people play at your Pioneer event? I’ll tune the 15-card sideboard to them.
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind for your blue-black deck, or should I suggest one?
  - Options: I have a commander in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which Commander bracket does your table play? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized blue-black deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, Modern, Pioneer, or something else?
  - Options: Commander / Standard / Modern / Pioneer / Pauper
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a preferred color or colors?
...
- [catalog slot=format row=format fit=0.90 filled=false] Which format should the deck be: Commander, Standard, Modern, Pioneer, Pauper, or something else?
  - Options: Commander / Standard / Modern / Pioneer / Pauper
- [catalog slot=theme row=theme fit=0.90 filled=false] What should the deck focus on— a creature type, mechanic, or play style?
...
- [catalog slot=locked row=locked fit=0.05 filled=false] Must the deck keep Sanguine Bond, or may I cut cards that don’t fit the lifegain plan?
  - Options: Keep every card you named / Cut cards that don’t fit
  - Refused as a reword (D-88): Do you want to keep Sanguine Bond in the deck, or may I cut a card that does not fit the plan?
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which commander do you want: Vito, Thorn of the Dusk Rose, Heliod, Sun-Crowned, or Haliya, Guided by Light? Choose “None—name three more” and I’ll suggest three additional options.
...
- [catalog slot=meta row=meta fit=0.90 filled=true] What decks do people play at your event so I can tune the 15-card sideboard to it?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your collection first, use only cards in your collection, or ignore your collection for a fully optimized deck?
  - Options: Use my collection first / Use only my collection / Ignore my collection
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should this Pauper burn deck be: casual, FNM level, or tournament meta?
  - Options: Casual / FNM level / Tournament meta
- [catalog slot=budget row=budget fit=0.20 filled=true] What is your budget for buying cards?
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Peregrin Took, Rosie Cotton of South Lane, or Quina, Qu Gourmet? Choose “None—name three more” if you want three additional options.
...
- [INVENTED slot=pool_rule row=pool fit=0.05 filled=true] Should I build the Gishath Dinosaur deck from your library first, only from your library, or ignore your library?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=house_rules row=house_rules fit=0.50 filled=true] When you say anything goes, do you mean any card with no ban list, or Vintage rules?
  - Options: Any card, no ban list / Vintage rules

**Turn 2, the user:** Any card, no ban list. Call it Vintage. An artifact prison deck.

- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] For your Vintage artifact prison deck, should the normal limits apply: at least 60 cards, no more than four copies of a card by name, and a 15-card sideboard?
  - Options: Yes, the normal limits / No, I will specify the limits
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How powerful should your Vintage artifact prison deck be: casual, FNM level, or tournament-meta?
  - Options: Casual / FNM / Tournament-meta
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference for your Vintage artifact prison deck? It is strongest in blue and red.
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for your land destruction Commander deck?
  - Options: I have a commander in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which bracket does your table play? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Jodah, the Unifier, The Earth King, or Toph, Hardheaded Teacher? Choose “None—name three more” if you want three additional options.
  - Options: Jodah, the Unifier / The Earth King / Toph, Hardheaded Teacher / None—name three more
- [catalog slot=power row=table_tolerance fit=0.90 filled=true] Does your table allow mill, land destruction, extra turns, or stax?
  - Options: Yes / No / Mill only
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Toph, the Blind Bandit, Haru, Hidden Talent, or Rydia, Summoner of Mist? Choose “None—name three more” if you want three additional options.
  - Options: Toph, the Blind Bandit / Haru, Hidden Talent / Rydia, Summoner of Mist / None—name three more

**Turn 4, the user:** My table does not mind.

- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Toph, the Blind Bandit; Haru, Hidden Talent; or Rydia, Summoner of Mist? You can say “none” and I’ll name three more.
  - Options: Toph, the Blind Bandit / Haru, Hidden Talent / Rydia, Summoner of Mist / None—name three more
...
- [catalog slot=commander row=commander_pick fit=0.20 filled=false] Which commander do you want: Thalia, Guardian of Thraben, Pippin, Guard of the Citadel, or Kataki, War's Wage? You can also say “none” and I’ll name three more.
  - Options: Thalia, Guardian of Thraben / Pippin, Guard of the Citadel / Kataki, War's Wage / None—name three more
  - Refused as a reword (D-88): Which one do you want: Thalia, Guardian of Thraben, Pippin, Guard of the Citadel, or Kataki, War's Wage? Say "none" and I name three more.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Thalia, Guardian of Thraben, Pippin, Guard of the Citadel, or Kataki, War's Wage? Choose “None—name three more” if you want three additional options.
  - Options: Thalia, Guardian of Thraben / Pippin, Guard of the Citadel / Kataki, War's Wage / None—name three more
...
- [catalog slot=commander row=named_card_role fit=0.00 filled=true] Would you like Grist, the Hunger Tide as your commander or as one of the other 99 cards?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] What bracket does your playgroup use: 1 exhibition, 2 core (precon level), 3 upgraded, 4 optimized (high power), or 5 cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library first, restrict the deck to only your library, or ignore your library for a fully optimized build?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=locked row=locked fit=0.20 filled=false] Must the deck keep Grist, the Hunger Tide and Grist, or may I cut a card that does not fit the sacrifice plan?
  - Options: Keep Grist, the Hunger Tide and Grist / Cut what does not fit
  - Refused as a reword (D-88): Should the deck keep Grist, the Hunger Tide in the 99, or may I cut a card that does not fit the plan?

**Turn 4, the user:** You pick the commander, and keep Grist in the deck.

- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Gríma Wormtongue, Old Man Willow, or The Sackville-Bagginses? You can also say “none” and I’ll name three more.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which commander do you want: Joshua, Phoenix's Dominant // Phoenix, Warden of Fire, Aerith, Last Ancient, or Sauron, the Necromancer? Choose “None—name three more” if you want three additional options.
  - Options: Joshua, Phoenix's Dominant // Phoenix, Warden of Fire / Aerith, Last Ancient / Sauron, the Necromancer / None—name three more
...
- [catalog slot=commander row=commander fit=0.20 filled=false] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=budget row=budget_scope fit=0.20 filled=true] Is that a cap on the cards you buy, or on the whole deck value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind for your white-and-black lifegain deck, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=false] Which bracket does your table play for this white-and-black lifegain deck? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, Modern, Pioneer, or Pauper?
  - Options: Commander / Standard / Modern / Pioneer / Pauper
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference? Sacrifice decks are strongest in black.

**Turn 2, the user:** Commander, black and green. Meren of Clan Nel Toth is the commander.

- [catalog slot=power row=power_commander fit=0.90 filled=true] Which bracket does your black-green Meren of Clan Nel Toth Commander deck fit? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_sixty fit=0.05 filled=true] How strong should your competitive Modern deck be: casual, FNM level, or tournament-meta?
  - Options: Casual / FNM / Tournament-meta
  - Refused as a reword (D-88): How strong should this be: casual, FNM level, or tournament-meta?
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [INVENTED slot=meta row=meta fit=0.20 filled=false] What do people play at your Modern event?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you already have a commander in mind, or would you like me to suggest one?
  - Options: I have a commander in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which bracket does your playgroup use? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have any color preferences? Dragon decks are strongest in blue and red.

**Turn 3, the user:** Bracket 3, red and green.

- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want for your bracket 3 red-green dragon deck: Lathliss, Dragon Queen, Atarka, World Render, or Miirym, Sentinel Wyrm? Or say “none” and I’ll name three more.
...
- [catalog slot=house_rules row=house_rules fit=0.90 filled=false] When you say no proxies, does your table allow any card with no ban list, or do you use Vintage rules?
  - Options: Any card, no ban list / Vintage rules
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander would you like for your bracket 3 dinosaur stompy deck from your binder, or should I suggest three more?

**Turn 3, the user:** yeah 50 bucks max

- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Ghalta, Primal Hunger; Reptil, Dinomorpher; Itzquinth, Firstborn of Gishath; or should I name three more?
  - Options: Ghalta, Primal Hunger / Reptil, Dinomorpher / Itzquinth, Firstborn of Gishath / None—name three more
- [catalog slot=budget row=budget_scope fit=0.20 filled=false] Is your $50 maximum for the cards you buy or for the whole deck value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket does your Commander table play at? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck be built from your library first, only from your library, or should your library be ignored for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should your Black Lotus deck be: casual, FNM level, or tournament-meta?
  - Options: Casual / FNM / Tournament-meta
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have any color preference? Black Lotus decks are strongest in black.
...
- [catalog slot=theme row=theme_card_named fit=0.90 filled=true] What should your Thrasios, Triton Hero and Tymna the Weaver deck focus on: a creature type, a mechanic, or a play style?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, Modern, Pioneer, or Pauper?
  - Options: Commander / Standard / Modern / Pioneer / Pauper
- [catalog slot=colors row=colors fit=0.90 filled=true] Does your brother have any color preference? Zombie decks are strongest in blue and black.
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a black commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [INVENTED slot=power row=power_commander fit=0.20 filled=true] What power level should the black Zombie deck target: 2 (precon level), 3 (upgraded), or 4 (high power)?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Gisa, the Hellraiser; Zul Ashur, Lich Lord; or Hancock, Ghoulish Mayor? Choose “None—name three more” if you’d like three additional options.
...
- [catalog slot=power row=power_sixty fit=0.05 filled=true] How strong should your Modern Burn sideboard be: casual, FNM level, or tournament-meta?
  - Options: Casual / FNM / Tournament-meta
- [INVENTED slot=colors row=colors fit=0.20 filled=true] Should the sideboard use red only, or are other colors acceptable?
  - Options: Red only / Other colors are acceptable
  - It replaced: Any color preference? A burn deck is strongest in red.

**Turn 2, the user:** Modern, burn, mono red. Tournament level.

- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do people play at your tournament? I’ll tune the 15-card sideboard to that metagame.
...
- [INVENTED slot=house_rules row=house_rules fit=0.05 filled=false] Are there any house rules you want applied to this Standard deck?
  - Options: Any card, no ban list / Vintage rules
...
- [catalog slot=format row=format fit=0.05 filled=true] Which format: Commander, Standard, Modern, or something else?
  - Options: Commander / Standard / Modern / Pioneer / Pauper
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format should we start with: Commander or Modern?
  - Options: Commander / Modern
- [catalog slot=theme row=theme fit=0.90 filled=true] What should the decks do: a creature type, a mechanic, or a play style?
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have any color preferences for the decks?
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which commander do you want: Nylea, God of the Hunt, Verdeloth the Ancient, or Nemata, Grove Guardian? You can say “none” and I’ll name three more.
  - Options: Nylea, God of the Hunt / Verdeloth the Ancient / Nemata, Grove Guardian / None—name three more
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a blue-black commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=table_tolerance fit=0.20 filled=false] Does your Bracket 3 table accept mill, land destruction, extra turns, or stax?
  - Options: Yes / No / Mill only
