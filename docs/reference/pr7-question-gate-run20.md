...
| Catalog questions that closed a slot | 107 |
...
- Calls: 731. Time: 1111.3 seconds.
- Tokens: 710714 input (298944 cached), 63203 output.
- Cost: $0.1642.
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Would you like Grist, the Hunger Tide to lead the deck, or should Grist be one of the other cards?
...
- [catalog slot=format row=format fit=0.90 filled=true] Which format would you like: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
- [catalog slot=power row=jank fit=0.90 filled=true] When you say “janky,” do you mean a low-power deck, an unexpected card, or a plan that almost never works?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the Brago blink deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 — exhibition / 2 — core / 3 — upgraded / 4 — optimized / 5 — cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=budget row=budget fit=0.90 filled=false] Is there a budget for cards you may need to buy?
...
- [catalog slot=power row=power_commander fit=0.20 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
  - Refused as a reword (D-88): Should the deck target power 2 (precon level) or power 3 (upgraded)?
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] You have four dinosaur cards but need at least 30. Should I prioritize the cards you own and add a buy list, or use all available cards?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] The available card pool is thin for this theme. Should I build owned-first with a buy list, or use the whole pool?
  - Options: Owned-first with a buy list / Use the whole pool
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which one do you want: Thalia, Guardian of Thraben, Pippin, Guard of the Citadel, or Kataki, War's Wage? Say "none" and I name three more.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which one do you want: Pippin, Guard of the Citadel, Katara, Water Tribe's Hope, or Gwaihir the Windlord? Say "none" and I name three more.
  - Options: Pippin, Guard of the Citadel / Katara, Water Tribe's Hope / Gwaihir the Windlord / None, name three more
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format will you play at Friday Night Magic: Standard, Modern, or Commander?
  - Options: Standard / Modern / Commander
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [INVENTED slot=locked row=locked fit=0.20 filled=false] Should the deck keep Delver of Secrets, or may cards that do not fit the tempo plan be cut?
  - Options: Keep all named cards / Cut cards that do not fit
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target?
  - Options: Exhibition (1) / Core (2) / Upgraded (3) / Optimized (4) / cEDH (5)
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Since the available cards are limited for this theme, should I prioritize cards you own and provide a buy list, or use the entire card pool?
  - Options: Owned cards first, with a buy list / Use the entire card pool
...
- [catalog slot=commander row=named_card_role fit=0.20 filled=false] Should Karlov of the Ghost Council lead the deck, or be included among the other cards?
  - Options: As my commander / In the 99
  - Refused as a reword (D-88): Do you want Karlov of the Ghost Council as your commander?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library as a starting point, restrict the deck to it, or build without using it?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander_pick fit=0.20 filled=true] Which one do you want: Purphoros, God of the Forge, Ashling, Flame Dancer, or Dragonhawk, Fate's Tempest? Say "none" and I name three more.
  - Options: Purphoros, God of the Forge / Ashling, Flame Dancer / Dragonhawk, Fate's Tempest / None, name three more
  - Refused as a reword (D-88): Which one do you want: Purphoros, God of the Forge, Ashling, Flame Dancer, or Dragonhawk, Fate's Tempest? Say "none" and I name three more.
- [catalog slot=budget row=budget fit=0.90 filled=false] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.05 filled=false] Must the deck keep every card you named, or may I cut cards that do not fit the burn plan?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a black commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.20 filled=true] What power level should the deck target for a new player? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
  - Refused as a reword (D-88): Should the deck target bracket 2 (precon level), 3 (upgraded), or 4 (high power)?
  - The guard compared against: Which power bracket should the deck target? 2 is precon level, 3 is upgraded, 4 is high power.
...
- [INVENTED slot=power row=power_sixty fit=0.20 filled=true] What power level should the sideboard target: casual, FNM, or tournament-meta?
  - Options: Casual / FNM / Tournament-meta
  - It replaced: How strong should this be: casual, FNM level, or tournament-meta?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=meta row=meta fit=0.90 filled=true] Should I keep the sideboard general, or will you name the decks you expect to face?
  - Options: Keep it general / I’ll name the decks I expect to face
...
- [catalog slot=deck_count row=one_deck fit=0.05 filled=false] I build one deck at a time. Which deck do you want first?
  - Refused as a reword (D-88): Which deck do you want first: Commander or Modern?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I start with your library, use only your library, or ignore it for a fully optimized sacrifice deck?
...
- [catalog slot=pool_rule row=pool_precon fit=0.20 filled=true] Should I upgrade the precon, restrict the deck to cards from it, or build without using it?
  - Options: Start with the precon / Use only its cards / Ignore the precon
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the sideboard be: casual, FNM-level, or tournament meta?
  - Options: Casual / FNM-level / Tournament meta
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for sideboard cards?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for your colorless artifact deck?
  - Options: I have a commander in mind / Suggest one
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which one do you want: Aloy, Savior of Meridian, Maelstrom Wanderer, or Ojer Kaslem, Deepest Growth // Temple of Cultivation? Say "none" and I name three more.
  - Options: Aloy, Savior of Meridian / Maelstrom Wanderer / Ojer Kaslem, Deepest Growth // Temple of Cultivation / None, name three more
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target? Choose exhibition, core, upgraded, optimized, or cEDH.
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the enchantress deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.05 filled=true] What power level should the deck target? A beginner-friendly option would be suitable.
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [INVENTED slot=pool_rule row=pool fit=0.20 filled=false] Should the deck use only cards from your library, or can it use any cards for a fully optimized build?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Should Bruvac the Grandiloquent be the commander or one of the 99?
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=locked row=locked fit=0.20 filled=false] Must the deck keep Sol Ring, or may I cut a card that does not fit the plan?
  - Options: Keep every card I named / Cut what does not fit
  - Refused as a reword (D-88): May I cut Sol Ring if it does not fit the plan?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for your blue-red spellslinger deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=budget row=budget fit=0.90 filled=true] Is there a budget for cards to buy?
...
- [catalog slot=meta row=meta fit=0.90 filled=false] For a tournament-level deck, should I keep the sideboard general, or will you name the decks you expect to face?
  - Options: Keep the sideboard general / I’ll name the decks
...
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for cards to buy?
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] Which of the two common plans would you like for the deck?
