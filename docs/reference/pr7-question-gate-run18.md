...
74 probe conversations ran beside the gate. They asked 250 questions, and the model offered 13 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
| Catalog questions that closed a slot | 97 |
...
- Calls: 668. Time: 1278.0 seconds.
- Tokens: 655607 input (295247 cached), 59966 output.
- Cost: $0.1499.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which one do you want: Meneldor, Swift Savior, Gilraen, Dúnedain Protector, or Ennis, Debate Moderator? Say "none" and I name three more.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which one do you want: Abuelo, Ancestral Echo, Oji, the Exquisite Blade, or Niko, Light of Hope? Say "none" and I name three more.
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Should Grist, the Hunger Tide lead the deck, or should Grist be included among the other 99 cards?
  - Options: Use Grist as the commander / Include Grist in the 99
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] Should the deck use the usual limits of at least 60 cards, no more than four copies of a card name, and a 15-card sideboard?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format will you play at Friday’s event: Standard, Modern, or Commander?
...
- [catalog slot=budget row=budget_scope fit=0.90 filled=true] Does the 100 budget cover the cards you buy, or the whole deck's value?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should the deck use cards from your library first, use only cards from your library, or ignore your library?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck aim for? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=pool_rule row=pool_precon fit=0.05 filled=true] Should I start with your Atraxa, Praetors' Voice precon, limit the deck to cards from it, or ignore it for a fully optimized build?
...
- [catalog slot=pool_rule row=pool fit=0.20 filled=true] Should I use your library first, use only cards from your library, or ignore your library for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] For this custom deck, should I use a 60-card minimum, up to four copies of a card name, and a 15-card sideboard, or will you specify different limits?
  - Options: Yes, use the normal limits / No, I’ll specify the limits
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I prioritize cards from your library, restrict the deck to your library, or build without using it for maximum optimization?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for a white-blue deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_sixty_confirm fit=0.05 filled=true] Should I build this for tournament-level competition?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
- [catalog slot=meta row=meta fit=0.90 filled=true] What decks do you expect to face so I can tune the 15-card sideboard?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only cards from it, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
- [INVENTED slot=locked row=locked fit=0.20 filled=false] May I cut Grist, the Hunger Tide, or must the deck include it another way?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for your blue-red artifact deck?
  - Options: I have one in mind / Suggest one
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format will you play at FNM: Standard, Modern, or Commander?
  - Options: Standard / Modern / Commander
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?

**Turn 2, the user:** Modern. The best deck under budget.

- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build for tournament-level competition, or are you aiming for FNM-level or casual play?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to face so I can tune the 15-card sideboard?
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How powerful should the Standard burn deck be: casual, FNM-level, or tournament meta?
  - Options: Casual / FNM-level / Tournament meta
...
- [catalog slot=theme row=theme_competitive fit=0.90 filled=true] Would you like a specific top-tier deck, or the strongest deck that fits your budget?
  - Options: A named deck / The best deck under budget
- [INVENTED slot=power row=power_sixty_confirm fit=0.20 filled=true] Should the deck target competitive tournament play, FNM-level play, or casual play?
  - Options: Yes, tournament level / No, FNM level / No, casual
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] For this custom format, should the deck use a 60-card minimum, four copies per name, and a 15-card sideboard?
  - Options: Yes, use the normal limits / No, I'll specify the limits
...
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to play against? I’ll use that to tune the 15-card sideboard.
...
- [catalog slot=meta row=meta fit=0.90 filled=false] Which decks do you expect to face? I’ll tune the 15-card sideboard to that.
...
- [catalog slot=locked row=locked fit=0.90 filled=false] Must the deck keep Lightning Bolt, or may I cut cards that do not fit the burn plan?
...
- [catalog slot=commander row=commander fit=0.05 filled=false] Do you have a commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build for tournament-level competition, or would you prefer FNM-level or casual power?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=false] Do you have a color preference?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library first, restrict the deck to cards from your library, or ignore your library for a fully optimized deck?
  - Options: Use my library first / Use only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind, or should I suggest one for a deck featuring big green creatures?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=false] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=false] Which one do you want: Jodah, the Unifier, The Earth King, or Toph, Hardheaded Teacher? Say "none" and I name three more.
...
- [catalog slot=commander row=commander_pick fit=0.90 filled=true] Which one do you want: Toph, Hardheaded Teacher, Rydia, Summoner of Mist, or Strider, Ranger of the North? Say "none" and I name three more.
  - Options: Toph, Hardheaded Teacher / Rydia, Summoner of Mist / Strider, Ranger of the North / None, name three more
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
- [catalog slot=locked row=locked fit=0.20 filled=false] Must the deck keep every card you named, or may I cut cards that do not fit the sacrifice plan?
  - Options: Keep every card I named / Cut what does not fit
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a commander in mind for the red-green dragon deck, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the dragon deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=house_rules row=house_format_limits fit=0.05 filled=true] Should the deck use the normal limits: at least 60 cards, up to four copies of a card name, and a 15-card sideboard?
  - Options: Yes, keep the normal limits / No, I’ll specify the limits
  - Refused as a reword (D-88): In your house format, do you use a 60-card minimum, allow four copies per name, and use a 15-card sideboard?
...
- [catalog slot=locked row=locked fit=0.20 filled=false] Should Sanguine Bond stay in the deck, or may I cut cards that do not fit the plan?
  - Options: Keep every card I named / Cut what does not fit
  - Refused as a reword (D-88): Should Sanguine Bond remain in the deck, or may I cut another card that does not fit the plan?
  - The guard compared against: Must the deck keep Sanguine Bond, or may I cut a card that does not fit the plan?
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=true] Should I build this as a tournament-level deck, or would you prefer FNM-level or casual power?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
- [catalog slot=budget row=budget fit=0.90 filled=true] Do you have a budget for buying cards?
...
- [catalog slot=power row=power_sixty_confirm fit=0.20 filled=false] You mentioned FNM—should I build for tournament level, FNM level, or casual play?
  - Options: Yes, tournament level / No, FNM level / No, casual
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is precon level, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [INVENTED slot=colors row=colors fit=0.20 filled=true] What color preference should the deck use?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a colorless commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [INVENTED slot=locked row=locked fit=0.05 filled=false] Should Sol Ring stay in the deck?
  - Options: Keep every card I named / Cut what does not fit
...
- [catalog slot=commander row=commander_pick fit=0.20 filled=false] Which one do you want: Jenova, Ancient Calamity, Shelob, Child of Ungoliant, or The Serpent Society? Say "none" and I name three more.
  ...
  - Refused as a reword (D-88): Which commander do you want to use: Jenova, Ancient Calamity; Shelob, Child of Ungoliant; The Serpent Society; or none?
...
- [catalog slot=power row=power_sixty_confirm fit=0.90 filled=false] Should I build the deck for tournament-level play?
  - Options: Yes, tournament level / No, FNM level / No, casual
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to face? I’ll use that to tune the 15-card sideboard.
...
- [catalog slot=theme row=theme_card_named fit=0.90 filled=true] What should the deck do: focus on a creature type, use a mechanic, or follow a play style?
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Do you want Atraxa, Praetor's Voice as your commander, or as one card in the 99?
  - Options: Use Atraxa, Praetor's Voice as my commander / Include Atraxa, Praetor's Voice in the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: 1 exhibition, 2 core, 3 upgraded, 4 optimized, or 5 cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the chaos deck target? Choose a bracket from 1 (exhibition) to 5 (cEDH).
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=theme row=theme fit=0.90 filled=true] What would you like the deck to focus on: a creature type, a mechanic, or a play style?
- [catalog slot=power row=power_commander fit=0.50 filled=true] What power level should the deck aim for: 1 exhibition, 2 core, 3 upgraded, 4 optimized, or 5 cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=commander row=named_card_role fit=0.05 filled=false] Do you want Bruvac the Grandiloquent to lead the deck, or should it be included among the other cards?
  - Options: As my commander / In the 99
...
- [catalog slot=meta row=meta fit=0.90 filled=false] What decks do you expect to face? I’ll tune the 15 sideboard cards to that.
...
- [catalog slot=budget row=budget_scope fit=0.90 filled=false] Is the $200 a cap on the cards you buy, or on the whole deck's value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=plan_variant row=plan_choice fit=0.90 filled=false] Which plan do you want the deck to emphasize: artifacts or lifegain?
  - Options: Artifact-focused / Lifegain-focused
