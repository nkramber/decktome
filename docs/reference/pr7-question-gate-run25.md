...
74 probe conversations ran beside the gate. They asked 293 questions, and the model offered 10 replacements. A probe explores catalog coverage and does not move the verdict (D-96).
...
- Calls: 690. Time: 1252.0 seconds.
- Tokens: 762103 input (344736 cached), 64567 output.
- Cost: $0.1678.
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for your white-black deck?
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=true] Would you like Grist, the Hunger Tide to lead the deck, or should Grist be included among the other cards?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target? Level 2 is near a preconstructed deck, level 3 is upgraded, and level 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] Would you like the deck built from your owned cards first with a buy list, or should it use the entire available card pool?
...
- [catalog slot=format row=format_store fit=0.90 filled=false] Which format will you be playing on Friday?
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for this white-black deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: exhibition, core (near a precon), upgraded, high power, or cEDH?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for? Choose 2 for a core, precon-like build, 3 for upgraded, or 4 for high power.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
...
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong would you like the deck to be: casual, FNM level, or tournament-meta?
...
- [catalog slot=pool_rule row=pool_precon fit=0.05 filled=true] Should I start with your precon, restrict the deck to its cards, or ignore it for a fully optimized build?
...
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] To reach at least 30 Dinosaurs, should I prioritize cards you already own and add a buy list, or use the entire available pool?
  - Options: Prioritize owned cards and add a buy list / Use the entire pool
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is the core level, near a precon; 3 is upgraded; 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool_thin fit=0.90 filled=true] For this extra-turns deck, should I prioritize cards you own and provide a buy list, or use the whole pool?
  - Options: Owned-first with a buy list / Use the whole pool
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a commander in mind, or should I suggest one for your black-green sacrifice deck?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use your library as a starting point, restrict the deck to cards in it, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have a blue-red commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=budget row=budget_scope fit=0.50 filled=true] Is your budget a cap on the cards you buy, or on the deck's total value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=format row=format_store fit=0.90 filled=true] Which format does your event use: Standard, Modern, or Commander?
  - Options: Standard / Modern / Commander
...
- [INVENTED slot=budget row=budget fit=0.20 filled=true] What is the maximum you want to spend on cards?
...
- [catalog slot=house_rules row=house_format_limits fit=0.90 filled=true] Inside your house format, do the normal 60-card deck limits hold?
  - Options: Yes, the normal limits / No, I will say the limits
- [catalog slot=power row=power_sixty fit=0.90 filled=true] How strong should the artifact prison deck be: casual, FNM-level, or tournament-level?
  - Options: Casual / FNM-level / Tournament-level
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a white-black commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=false] Which power bracket should the deck target: 1 exhibition, 2 core (near a preconstructed deck), 3 upgraded, 4 optimized, or 5 cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck aim for?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I prioritize cards from your library, use only cards from it, or ignore it?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander_pick fit=0.20 filled=false] Which one do you want: Atarka, World Render, Thrakkus the Butcher, or Dragonlord Atarka? Say "none" and I name three more.
...
- [INVENTED slot=budget row=budget_scope fit=0.05 filled=false] Does your $50 limit apply to the cards you purchase, or to the deck’s total value?
  - Options: Cards I buy / The entire deck
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Should Karlov of the Ghost Counsel lead the deck, or be one card in the 99?
  - Options: As my commander / In the 99
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power bracket should the deck target? Level 2 is near a precon, level 3 is upgraded, and level 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I prioritize cards from your library, use only cards from your library, or disregard it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=commander_illegal fit=0.05 filled=true] Lightning Bolt can not lead a deck. Shall I suggest a commander instead?
  ...
  - Refused as a reword (D-88): Lightning Bolt is not a creature and cannot be your commander. Would you like to choose a legal commander instead?
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target: 1 exhibition, 2 core, 3 upgraded, 4 optimized, or 5 cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target for a new player? 2 is the core level, near a precon; 3 is upgraded; 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the land destruction deck target? Choose 1 for exhibition, 2 for core, 3 for upgraded, 4 for optimized, or 5 for cEDH.
  - Options: Exhibition / Core / Upgraded / Optimized / cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target? 2 is core and near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 — Exhibition / 2 — Core / 3 — Upgraded / 4 — Optimized / 5 — cEDH
...
- [catalog slot=format row=format_unsupported_open fit=0.05 filled=false] I do not build Pauper. Which format should I build instead: Commander, Standard, or Modern?
  - Options: Commander / Standard / Modern
  - Refused as a reword (D-88): Which format should I build instead: Commander, Standard, or Modern?
- [catalog slot=budget row=budget fit=0.90 filled=true] Is there a maximum amount you want to spend on cards?
...
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I use cards from your library first, only cards from your library, or not use it for a fully optimized deck?
  - Options: Use my library first / Use only my library / Don't use my library
- [catalog slot=budget row=budget_scope fit=0.90 filled=true] Is your budget a limit on the cards you buy or on the whole deck's value?
...
- [catalog slot=power row=power_commander fit=0.90 filled=false] Which power bracket should the deck target: 2, 3, or either one?
  - Options: Bracket 2 / Bracket 3 / Either 2 or 3
- [catalog slot=budget row=budget fit=0.90 filled=false] How much would you like to spend on cards you don’t already have?
...
- [catalog slot=power row=power_commander fit=0.90 filled=true] What power level should the deck target: 1 exhibition, 2 core (near a precon), 3 upgraded, 4 optimized, or 5 cEDH?
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=commander row=commander fit=0.90 filled=false] Do you have a black-green commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=pool_rule row=pool fit=0.50 filled=false] Should I start with cards from your library, use only cards from your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
...
- [catalog slot=commander row=named_card_role fit=0.90 filled=false] Do you want Bruvac the Grandiloquent to lead the deck, or be one card in the 99?
  - Options: As my commander / In the 99
- [catalog slot=pool_rule row=pool fit=0.90 filled=true] Should I build from your library first, use only your library, or ignore it for a fully optimized deck?
  - Options: Library first / Only my library / Ignore my library
- [catalog slot=budget row=budget_scope fit=0.90 filled=false] Is that a cap on the cards you buy, or on the deck's total value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=theme row=theme fit=0.90 filled=true] What would you like the deck to do—a creature type, a mechanic, or a play style?
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power level should the deck target? Level 2 is near a preconstructed deck, level 3 is upgraded, and level 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
...
- [catalog slot=budget row=budget_scope fit=0.20 filled=false] Is the $200 a cap on the cards you buy, or on the whole deck's value?
  - Options: The cards I buy / The whole deck
...
- [catalog slot=commander row=commander fit=0.90 filled=true] Do you have an Eldrazi commander in mind, or should I suggest one?
  - Options: I have one in mind / Suggest one
- [catalog slot=power row=power_commander fit=0.90 filled=true] Which power bracket should the deck target? 2 is the core level, near a precon, 3 is upgraded, and 4 is high power.
  - Options: 1 exhibition / 2 core / 3 upgraded / 4 optimized / 5 cEDH
- [catalog slot=colors row=colors fit=0.90 filled=true] Do you have a color preference?
