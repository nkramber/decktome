...
Run date: 2026-09-11. Card snapshot: 2026-09-04. Model: 20260911T175858Z.
...
|---|---|---|---|---|---|---|---|---|---|
| commander | 23628 | 9229 | 6145 | 240 | 15134 | 0.96 of 97450 (bar 0.90) | 0.95 of 788 (bar 0.95) | 0.87 of 99933 | 0.55 |
...
| Commander broken copies graded bad (D-674) | 4141 of 5905 |
...
| Evasive Maneuvers (2017-06-09) | baseline | 0.75 | 266 of 571 |
...
| Quick Draw (2024-04-19) | baseline | 0.77 | 218 of 500 |
...
| synergy | 232 | 36 | 24.93 | 12.61 | 0.00 | -0.29 | 19 of 36 |

Confusion on the holdout over the folds, rows are the label and columns the grade, worst first:

- bad: [4141 1354 405 5 0]
- baseline: [58 73 57 1 0]
- typical: [71 286 622 49 12]
- good: [247 98 296 1308 2051]
- great: [239 88 260 1284 2129]
...
- Suite `quality`, run `pr14b-quality-gate-run20`, on 2026-09-11, commit `edbe1d3`.
- Roles: none, no provider call.
- Versions: card snapshot 2026-09-04, commanders_day `2026-09-07`, quality_model `20260911T175858Z`.
- Calls: 0. Cost: unpriced. Time: 102 seconds.

## Verdict

Verdict: PASS. Time: 102 seconds, no provider call.
