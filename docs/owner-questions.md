...
| OQ-61 | Which terse conversations join the catalog-only bar, and at what bar? D-427 names 14, the count of 2026-08-25, and `conversations.json` holds 47 with "terse:" in the name on 2026-09-04. The bar is 25 of 30 counted conversations today. My recommendation: all 47 join, the bar stays at the same share, 83 percent, so 64 of 77, and the harness rebases every number on the first run after the change. | D-105 froze the 30 and D-427 named the 14, and the bar is the meaning of the verdict. | Slice 4 of PR-15 keeps the 47 as probes until you answer. Their expectation rows are information, not gate rows. |
