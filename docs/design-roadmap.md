...
**PR-14C: MTGTop8 and the casual 60-card decks (D-482, D-490, D-493, D-502 to D-505).** 🔧 built 2026-09-03 on branch `pr-14c`. `docs/reference/pr14c-sources-2026-09-03.md` holds every verified fact.
...
22. PR-24 precon exclusion (D-409, D-460) ✅ merged 2026-09-03 (#59). Then PR-14C (D-482), then I-1, I-2, I-3 on evidence. PR-14B moved into step 19 (D-460).
