...
**PR-20: Deck view and card detail (D-318, D-507).** 🔧 built 2026-09-03 on branch `pr-20`. The free gate is `docs/reference/pr20-gate-2026-09-03.md`.
