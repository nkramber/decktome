...
**PR-32: The commander the reader named, and the pool they chose (F-75, F-76).** 🔧 planned 2026-09-08, right after PR #97. The first walks of the deployed app found both, and one feedback row names each.
...
**The first work of this slice is the runtime read, and no fix goes in without it.** The owner chose the hard filter, and it applies once the reader answers the pool question (OQ-79).
