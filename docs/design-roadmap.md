...
| F-49 | **No channel carries a user's verdict on a question, a summary, a card, or a deck.** The owner told the agent "this question was already answered", "this card does not belong in this deck", and "this deck is inaccurate against my specs" many times in the sessions of 2026-08 and 2026-09, and every one of those reached a fix by hand. An invited user has no way to say the same, and nothing reads it. Found 2026-09-06 when the owner asked for the feedback system (D-557). Binds PR-27, PR-28. | 🔧 planned |
