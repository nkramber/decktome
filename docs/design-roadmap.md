...
**PR-15: Eval harness.** 🔧 built 2026-09-04 on branch `pr-15` (D-511, D-512), all six slices. The free gate is `docs/reference/pr15-gate-2026-09-04.md`. The paid gate ran on 2026-09-04 (D-513 to D-516). Every lane passes, and deck gate run 16, question gate run 35, and revise gate run 9 are the baselines. `docs/reference/pr15-paid-gate-2026-09-04.md` holds the read with F-36 to F-39. OQ-57 to OQ-61 wait on the owner. The "Tier 1 nightly" line below is a question (OQ-57), and the text stays as written. The sweep runs on the owner's machine under a cap, and CI runs Tier 0 alone.
...
21. PR-15 eval harness. 🔧 built 2026-09-04 on branch `pr-15`, after #64 (D-511), before PR-22 and PR-23. The paid gate ran the same day and passes on every lane (D-516). M-5 manual scoring runs on the first UI build (after PR-12).
