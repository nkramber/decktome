...
**PR-15: Eval harness.** 🔧 built 2026-09-04 on branch `pr-15` (D-511, D-512), all six slices. The free gate is `docs/reference/pr15-gate-2026-09-04.md`. The owner said go to the paid gate on 2026-09-04 (D-513), and the next session runs it: the hand-off holds the procedure. OQ-57 to OQ-61 wait on the owner. The "Tier 1 nightly" line below is a question (OQ-57), and the text stays as written. The sweep runs on the owner's machine under a cap, and CI runs Tier 0 alone.
