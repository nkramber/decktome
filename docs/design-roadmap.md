...
**PR-24: Precon exclusion (D-407 to D-409).** 🔧 built 2026-09-03 on branch `pr-24` (D-496 to D-498, D-500, D-501). The free gate is `docs/reference/pr24-precon-gate-2026-09-03.md`.
...
22. PR-24 precon exclusion (D-409, D-460) 🔧 built 2026-09-03 on branch `pr-24`, then PR-14C (D-482), then I-1, I-2, I-3 on evidence. PR-14B moved into step 19 (D-460).
