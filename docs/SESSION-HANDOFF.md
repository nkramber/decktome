...
**PR-33 is the next code item** (2026-09-08, F-77, F-78, D-609). Two deployed builds ran four minutes and gave the reader nothing. `docs/reference/on-band-plan-2026-09-08.md` holds the read and the plan, and the roadmap holds the entry and sequence item 28. The plan waits for the owner's word. OQ-81 asks when the paid effort measurement of D-610 runs.
