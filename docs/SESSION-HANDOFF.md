...
- PR-15, the eval harness, is in progress on branch `pr-15`, from `main` at f299289 (D-511, 2026-09-04), before PR-22 and PR-23. The branch holds all six slices: the run files, the compare, Tier 0 in CI, the golden expectations, the plan judge, and the sweep. The section "PR-15, what the branch holds" below holds the moving parts, and "PR-15, the eval harness, prepared" holds the plan and the four owner questions, OQ-57 to OQ-60.
