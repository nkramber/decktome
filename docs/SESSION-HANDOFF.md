...
2026-08-23, session 1 (exploratory design).
...
The design doc is a first draft. The owner has not reviewed it. No code exists.
...
2. Ask the open questions that gate Phase 1 (OQ-2, OQ-7) when the owner is ready.
