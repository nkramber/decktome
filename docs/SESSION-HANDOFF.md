...
- **Eleven defects came out of the deploy and the first walk** (2026-09-07, F-57 to F-67). Ten of them are fixed:
  ...
  - F-59, the uninvited reader that reached the whole shell (2026-09-08, D-589, and D-590 after the first fix failed).
  ...
  **F-60 waits.** The binder shows the art of another printing, and not the copy the reader owns. A collection holds a set code and a collector number per copy, and the binder screen reads a different printing for the image.
