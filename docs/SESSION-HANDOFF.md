...
1. The three work items of 2026-09-04, one branch each (D-531). The first, the precon check, merged as #67 (D-532, D-533). The second, the terse conversations (D-522, D-534 to D-539), sits on branch `terse-bar`. Run 42 passes and is the baseline, and PR #68 is open. The precon check ignores basic lands (D-523, F-35). The 47 terse conversations join the bar (D-522). One paid run of about $0.28 rebases the gate with the new threshold. A trimmed card snapshot of at most 10 MB serves Tier 0 (D-521).
