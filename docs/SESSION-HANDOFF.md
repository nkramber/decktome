...
- **Nine defects came out of the deploy and the first walk** (2026-09-07, F-57 to F-67). Ten of them are fixed:
  ...
  - F-62, the thread that lumped every answer of a turn into one block, and dropped a decline.
  - F-63, the Build entry that cleared the reader's collection with no word.
  ...
  **F-59 waits.** An uninvited reader still reaches the whole shell, and one panel alone carries the refusal. The API refuses every data call, so no data leaves.
...
- **The next items.** The build walk of the PR-22 gate comes first, then F-59, then PR-25 (D-547, D-555). PR-28 follows the first real feedback (D-557). PR-29, the casual corpus, still stands on the weak-axes plan (D-567). The next EDHREC read falls on 2026-09-14.
