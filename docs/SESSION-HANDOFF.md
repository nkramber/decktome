...
- The owner read the PR on 2026-09-02: the stepper works, and the gate line of PR-19 holds. Two tile fixes followed: a deck's count includes the commander, so a Commander deck reads 100 (D-454), and the favorite star sits with the delete button at the right edge (D-455).
