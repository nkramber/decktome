...
1. The three work items of 2026-09-04, one branch each (D-531). The first, the precon check, is on branch `precon-basic-lands` and waits for its commit and PR (D-532). The precon check ignores basic lands (D-523, F-35). The 47 terse conversations join the bar (D-522). One paid run of about $0.28 rebases the gate with the new threshold. A trimmed card snapshot of at most 10 MB serves Tier 0 (D-521).
