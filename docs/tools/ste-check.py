...
The checker applies these rules (D-304):
...
ING_ALLOW = {
    ...
    "docstrings", "lightning", "mulligan", "cycling", "scrying", "surveilling", "milling",
    "looting", "rummaging", "ramping", "tapping", "casting", "blinking", "flickering",
    "kicking", "fading", "phasing", "dredging", "goading", "landing", "dueling",
