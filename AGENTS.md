...
- One concern per pull request. Squash merge into `main`, the one merge method that the repository allows. After the Codex approval, the author session gives the owner a summary in four sections: What, How, CI, and Codex review. It turns on the auto-merge after the owner confirms (D-828, D-834, D-836).
