...
| Commander (pick) | The row waits for the power, the theme, and the colors, because the offer ranks on all three (D-630, D-669). A preference question beside an offer asks for an answer the offer already ignored. The user asked the agent to name a commander (D-71). The row asks again only with names the user has not seen: a refusal retires the old ones (D-73, D-80), and the color check drops the names the colors exclude (D-153). The same three names never go out twice (D-163). | "Which commander do you want: {A}, {B}, or {C}? Say 'none' and I name three more." |
