...
| Commander (pick) | The row waits for the power, because the offer ranks on the bracket (D-630). The user asked the agent to name a commander (D-71). The row asks again only with names the user has not seen: a refusal retires the old ones (D-73, D-80), and the color check drops the names the colors exclude (D-153). The same three names never go out twice (D-163). | "Which commander do you want: {A}, {B}, or {C}? Say 'none' and I name three more." |
