...
Stage (2026-09-11): **the app is live on `decktome.com`**, and pull request #147 is the newest merge. A merge to `main` deploys itself on Cloud Build (D-584, D-586, D-588). Phase 3B, the product UI, is the current phase.
