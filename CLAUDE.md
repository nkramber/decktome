...
**OQ-82 has an answer** (D-693 to D-697). A bracket promises its power in both directions, and a precon upgrade cuts a kept card that the bracket forbids. M-14 ran bracket gate run 2 on `main` for $1.37, and the judge agrees on 6 of 15 decks. The judge reads Game Changers from memory (F-123), and a commander in the 99 left a block (F-124). PR-46 fixes F-124 first, and PR-47 gives the judge the card flags before PR-45.
