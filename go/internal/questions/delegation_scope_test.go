...
// Both questions stay out, so the reader can still answer them. The slot
// may stand after the phrase or before it.
func TestADelegationDeclinesOnlyTheSlotItNames(t *testing.T) {
	for _, msg := range []string{
		"White and blue. You pick the commander.",
		"White and blue. For the commander, you pick.",
	} {
